...
<!--PATTERN basicLayout-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent" priority="1000" mode="M1">
...
<axsl:if test="count(hl7:query/hl7:person.deceasedTime/hl7:value/@value)=1 and count(hl7:query/hl7:person.deceasedTime/hl7:value)&gt;1">***fault|ErrorBase1742.ILLEGAL_DATE_FORMAT|multiple deceasedTime provided***<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:query/hl7:person.name/hl7:value/*)&gt;0"/><axsl:otherwise>***fault|ErrorBase1742.MISSING_MANDATORY_SEARCH_FIELD_AT|missing person name***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<!--PATTERN historicDataIndicatorCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:historicDataIndicator" priority="1000" mode="M2">
...
<!--PATTERN searchParameterCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:searchParameter" priority="1000" mode="M3">

		<!--ASSERT -->
<axsl:choose><axsl:when test="hl7:value[@codeSystem='2.16.840.1.113883.2.1.3.2.4.17.39']/@code='1' or hl7:value[@codeSystem='2.16.840.1.113883.2.1.3.2.4.17.39']/@code='2'"/><axsl:otherwise>***fault|ErrorBase1742.INVALID_SEARCH_TYPE|invalid searchParameter value provided***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<!--PATTERN ignoreHistoryCheck_MIM63-->
	...
	<!--RULE -->
<axsl:template match="/hl7:QUPA_IN000006UK02/hl7:ControlActEvent/hl7:query/hl7:ignoreHistoryIndicator" priority="1000" mode="M4">

		<!--ASSERT -->
<axsl:choose><axsl:when test="hl7:value/@code='0' or hl7:value/@code='1'"/><axsl:otherwise>***fault|ErrorBase1742.INVALID_IGNORE_HISTORY_INDICATOR|invalid ignoreSearchHistory value provided***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--REPORT -->
<axsl:if test="true()">***report|ignoreHistorySearch|<axsl:text/><axsl:value-of select="hl7:value/@code"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/></axsl:template><axsl:template match="text()" priority="-1" mode="M4"/><axsl:template match="@*|node()" priority="-2" mode="M4"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/></axsl:template>

<!--PATTERN ignoreHistoryCheck_MIM72-->


	<!--RULE -->
<axsl:template match="/hl7:QUPA_IN000006UK05/hl7:ControlActEvent/hl7:query/hl7:ignoreHistoryIndicator" priority="1000" mode="M5">
...
<!--PATTERN ignoreHistoryCheck_MIM72INTERNAL-->


	<!--RULE -->
<axsl:template match="/hl7:QUPA_IN000006SM99/hl7:ControlActEvent/hl7:query/hl7:ignoreHistoryIndicator" priority="1000" mode="M6">
...
<!--PATTERN administrativeGenderCodeCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:person.administrativeGenderCode" priority="1000" mode="M7">
...
<!--PATTERN birthTimeCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:person.birthTime" priority="1000" mode="M8">
...
<!--PATTERN deceasedTimeCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:person.deceasedTime" priority="1000" mode="M9">
...
<!--PATTERN nhsNumberCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:person.id" priority="1000" mode="M10">
...
<!--PATTERN nameReport-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:person.name" priority="1000" mode="M11">
...
<!--PATTERN addressReport-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:person.address" priority="1000" mode="M12">
...
<!--PATTERN primaryCareCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:primaryCare.id" priority="1000" mode="M13">
...
<!--PATTERN nhaisPostingReport-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:nhaisPosting" priority="1000" mode="M14">
