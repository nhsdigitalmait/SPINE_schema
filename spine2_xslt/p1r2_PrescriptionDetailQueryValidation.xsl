...
<!--PATTERN basicLayout-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*/hl7:ControlActEvent[1]/hl7:query[1]" priority="1000" mode="M14">

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:organization.id/hl7:value/@extension)=1"/><axsl:otherwise>***fault|ErrorBase1722.INVALID_REQUEST***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:prescription.id/hl7:value/@root)=1"/><axsl:otherwise>***fault|ErrorBase1722.INVALID_REQUEST***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:requesterOrganizationType/hl7:value[@codeSystem='2.16.840.1.113883.2.1.3.2.4.17.128']/@code)=1"/><axsl:otherwise>***fault|ErrorBase1722.INVALID_REQUEST***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M14"/></axsl:template><axsl:template match="text()" priority="-1" mode="M14"/><axsl:template match="@*|node()" priority="-2" mode="M14"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M14"/></axsl:template>

<!--PATTERN extractQuery-->


	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*/hl7:ControlActEvent[1]/hl7:query[1]" priority="1000" mode="M15">

		<!--REPORT -->
<axsl:if test="true()">***report|organizationID|<axsl:text/><axsl:value-of select="hl7:organization.id/hl7:value/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|prescriptionID|<axsl:text/><axsl:value-of select="hl7:prescription.id/hl7:value/@root"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|requesterOrganizationType|<axsl:text/><axsl:value-of select="hl7:requesterOrganizationType/hl7:value[@codeSystem='2.16.840.1.113883.2.1.3.2.4.17.128']/@code"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:prescription.repeatNumber/@value)=1">***report|currentInstance|<axsl:text/><axsl:value-of select="hl7:prescription.repeatNumber/@value"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M15"/></axsl:template><axsl:template match="text()" priority="-1" mode="M15"/><axsl:template match="@*|node()" priority="-2" mode="M15"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M15"/></axsl:template></axsl:stylesheet>
