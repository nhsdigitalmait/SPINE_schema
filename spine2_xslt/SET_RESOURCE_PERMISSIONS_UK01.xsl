...
<!--PATTERN BodyChecks-->
	...
	<!--RULE -->
<axsl:template match="hl7:SET_RESOURCE_PERMISSIONS_INUK01" priority="1000" mode="M8">
...
<axsl:choose><axsl:when test="count(hl7:ControlActEvent[1]/hl7:author1)=1 or count(hl7:ControlActEvent[1]/hl7:author1)=2"/><axsl:otherwise>***fault|ErrorBase1732.CONTROL_ACT_AUTHOR_INVALID_CARDINALITY***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:ControlActEvent[1]/crs:setResourcePermissionsRequest)=1 and count(hl7:ControlActEvent[1]/crs:setResourcePermissionsRequest/*)&gt;0"/><axsl:otherwise>***fault|ErrorBase1732.CONTROL_ACT_QUERY_INVALID***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<!--PATTERN AuthorCheck-Person-->
	...
	<!--RULE -->
<axsl:template match="hl7:SET_RESOURCE_PERMISSIONS_INUK01/hl7:ControlActEvent[1]/hl7:author" priority="1000" mode="M9">
...
<!--PATTERN AuthorCheck-System1-->
	...
	<!--RULE -->
<axsl:template match="hl7:SET_RESOURCE_PERMISSIONS_INUK01/hl7:ControlActEvent[1]/hl7:author1[1]/hl7:AgentSystemSDS/hl7:agentSystemSDS" priority="1000" mode="M10">
...
<!--PATTERN AuthorCheck-System2-->
	...
	<!--RULE -->
<axsl:template match="hl7:SET_RESOURCE_PERMISSIONS_INUK01/hl7:ControlActEvent[1]/hl7:author1[2]/hl7:AgentSystemSDS/hl7:agentSystemSDS" priority="1000" mode="M11">
...
<!--PATTERN ReportMPSDetailsWSA-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Header[1]" priority="1000" mode="M12">
...
<!--PATTERN basicLayout-->
	...
	<!--RULE -->
<axsl:template match="hl7:SET_RESOURCE_PERMISSIONS_INUK01/hl7:ControlActEvent" priority="1000" mode="M13">

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(crs:setResourcePermissionsRequest/crs:permissions/crs:resourceContext)=1"/><axsl:otherwise>***fault|ErrorBase1712.MANDATORY_DATA_MISSING|Resource Context not found***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:variable name="accessControlAssertionCount" select="count(crs:setResourcePermissionsRequest/crs:permissions/crs:accessControlAssertion)"/><axsl:variable name="permissionsStoreCount" select="count(crs:setResourcePermissionsRequest/crs:permissions/crs:accessControlAssertion/crs:function[crs:context='Consent'][crs:code='Store'])"/><axsl:variable name="permissionsViewCount" select="count(crs:setResourcePermissionsRequest/crs:permissions/crs:accessControlAssertion/crs:function[crs:context='Consent'][crs:code='View'])"/>

		<!--ASSERT -->
<axsl:choose><axsl:when test="$accessControlAssertionCount = 1 or $accessControlAssertionCount = 2"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_ACA_CARDINALITY|At least one and no more than two accessControlAssertion must be provided***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="$permissionsStoreCount=0 or $permissionsStoreCount=1"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_ACA_CARDINALITY|Only 1 Store permission can be provided***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="$permissionsViewCount=0 or $permissionsViewCount=1"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_ACA_CARDINALITY|Only 1 View permission can be provided***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="$permissionsViewCount=1 or $permissionsStoreCount=1"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_ACA_CARDINALITY|One of View or Store permission must be provided***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*" mode="M13"/></axsl:template><axsl:template match="text()" priority="-1" mode="M13"/><axsl:template match="@*|node()" priority="-2" mode="M13"><axsl:apply-templates select="*" mode="M13"/></axsl:template>

<!--PATTERN NHSNumberConsistencyCheck-->


	<!--RULE -->
<axsl:template match="//crs:accessControlAssertion[not(crs:function/crs:context='Sealing')]" priority="1000" mode="M14">

		<!--ASSERT -->
<axsl:choose><axsl:when test="((../crs:resourceContext/@extension)=(crs:resource/crs:Id))"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_COMBINATION_FC_RC_RI***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*" mode="M14"/></axsl:template><axsl:template match="text()" priority="-1" mode="M14"/><axsl:template match="@*|node()" priority="-2" mode="M14"><axsl:apply-templates select="*" mode="M14"/></axsl:template>

<!--PATTERN resourceContext-->


	<!--RULE -->
<axsl:template match="hl7:SET_RESOURCE_PERMISSIONS_INUK01/hl7:ControlActEvent/crs:setResourcePermissionsRequest/crs:permissions" priority="1000" mode="M15"><axsl:variable name="viewPermission" select="crs:accessControlAssertion[crs:function/crs:code='View']/crs:permission"/><axsl:variable name="storePermission" select="crs:accessControlAssertion[crs:function/crs:code='Store']/crs:permission"/><axsl:variable name="permissionCount" select="count(crs:accessControlAssertion)"/>

		<!--REPORT -->
<axsl:if test="$permissionCount=0">***fault|ErrorBase1712.MANDATORY_DATA_MISSING|Permission to Store or View not provided ***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--ASSERT -->
<axsl:choose><axsl:when test="$viewPermission=$storePermission or $permissionCount=1"/><axsl:otherwise>***fault|ErrorBase1712.MANDATORY_DATA_MISSING|Inconsistent Permission to View and Store***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(crs:resourceContext[@root='2.16.840.1.113883.2.1.4.1'])=1"/><axsl:otherwise>***fault|ErrorBase1712.MANDATORY_DATA_MISSING|Permission ResourceContext root=2.16.840.1.113883.2.1.4.1 not found***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(crs:resourceContext/@extension)=1"/><axsl:otherwise>***fault|ErrorBase1712.MANDATORY_DATA_MISSING|Permission ResourceContext extension not found***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--REPORT -->
<axsl:if test="count(crs:resourceContext/@extension)=1">***report|nhsNumberCode|<axsl:text/><axsl:value-of select="crs:resourceContext/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(crs:resourceContext/@root)=1">***report|nhsNumberCodeSystem|<axsl:text/><axsl:value-of select="crs:resourceContext/@root"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*" mode="M15"/></axsl:template><axsl:template match="text()" priority="-1" mode="M15"/><axsl:template match="@*|node()" priority="-2" mode="M15"><axsl:apply-templates select="*" mode="M15"/></axsl:template>

<!--PATTERN permissions-->


	<!--RULE -->
<axsl:template match="//crs:accessControlAssertion" priority="1000" mode="M16">

		<!--ASSERT -->
<axsl:choose><axsl:when test="crs:resource/crs:type='SCR'"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_COMBINATION_FC_RT|<axsl:text/><axsl:value-of select="crs:function/crs:context"/><axsl:text/>|<axsl:text/><axsl:value-of select="crs:resource/crs:type"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="crs:function/crs:context='Consent'"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_FUNCTION_CONTEXT|1234***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="crs:function/crs:code='Store' or crs:function/crs:code='View'"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_FUNCTION_CODE***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="crs:accessor/crs:type='Everyone' or crs:permission='Clear'"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_ACCESSOR_TYPE***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="crs:accessor/crs:accessorId/crs:name='Everyone' or crs:permission='Clear'"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_ACCESSOR_TYPE***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--REPORT -->
<axsl:if test="string-length(crs:permission)=0">***fault|ErrorBase1712.MISSING_PERMISSIONS_IN_SET***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*" mode="M16"/></axsl:template><axsl:template match="text()" priority="-1" mode="M16"/><axsl:template match="@*|node()" priority="-2" mode="M16"><axsl:apply-templates select="*" mode="M16"/></axsl:template>

<!--PATTERN permissionsExtractionView-->


	<!--RULE -->
<axsl:template match="//crs:accessControlAssertion[1]" priority="1000" mode="M17">

		<!--REPORT -->
<axsl:if test="true()">***BEGIN-LIST-ENTRY|report|accessControlAssertion***<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<axsl:if test="count(crs:accessor/crs:accessorId/crs:name)=1">+++accessorId|<axsl:text/><axsl:value-of select="crs:accessor/crs:accessorId/crs:name"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="crs:permission='Clear'">+++accessorIdType|Name+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="crs:permission='Clear'">+++accessorId|Everyone+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++function.context|Consent+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++function.code|View+++<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<axsl:if test="true()">+++resource.id|<axsl:text/><axsl:value-of select="crs:resource/crs:Id"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="true()">+++permission|<axsl:text/><axsl:value-of select="crs:permission"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN permissionsExtractionStore-->


	<!--RULE -->
<axsl:template match="//crs:accessControlAssertion[1]" priority="1000" mode="M18">
...
<axsl:if test="true()">+++function.context|Consent+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="true()">+++function.code|Store+++<axsl:value-of select="string('&#10;')"/></axsl:if>
