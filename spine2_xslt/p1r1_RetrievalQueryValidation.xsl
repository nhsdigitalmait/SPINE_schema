...
<axsl:template match="SOAP:Envelope[1]/SOAP:Header[1]/*[1]" priority="1000" mode="M7">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:interactionId[@root='2.16.840.1.113883.2.1.3.2.4.12'][@extension='QUPA_IN040000UK01'])=1"/><axsl:otherwise>***fault|ErrorBaseTms.INVALID_SOAP_INTERACTION_ID***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="count(hl7:communicationFunctionSnd[1]/hl7:device[1]/hl7:id[@root='2.16.840.1.113883.2.1.3.2.4.10'][1]/@extension)=1"/><axsl:otherwise>***fault|ErrorBase1732.INVALID_COMM_FUNC_SND***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:interactionId[@root='2.16.840.1.113883.2.1.3.2.4.12'][@extension='QUPA_IN040000UK01'])=1"/><axsl:otherwise>***fault|ErrorBase1732.INVALID_EXTENSION***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:ControlActProcess/hl7:pdsRetrievalQuery/*)&gt;0"/><axsl:otherwise>***fault|ErrorBase1732.CONTROL_ACT_RETRIEVAL_QUERY_INVALID***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<!--PATTERN RetrievalQueryChecks-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActProcess[1]/hl7:PdsRetrievalQuery" priority="1000" mode="M11">

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:person.id/hl7:value[@root='2.16.840.1.113883.2.1.4.1'])=1"/><axsl:otherwise>***fault|pdsquery|0***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="string-length(hl7:person.id/hl7:value[@root='2.16.840.1.113883.2.1.4.1']/@extension)&gt;0"/><axsl:otherwise>***fault|pdsquery|0***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:historicDataIndicator/hl7:value/@code)=1 and string-length(hl7:historicDataIndicator/hl7:value/@code)&gt;0"/><axsl:otherwise>***fault|pdsquery|0***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:retrievalItem[1]/hl7:semanticsText)=1 and string-length(hl7:retrievalItem[1]/hl7:semanticsText)&gt;0"/><axsl:otherwise>***fault|pdsquery|0***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M11"/></axsl:template><axsl:template match="text()" priority="-1" mode="M11"/><axsl:template match="@*|node()" priority="-2" mode="M11"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M11"/></axsl:template>

<!--PATTERN HeaderChecks-->


	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Header[1]/*[1]" priority="1000" mode="M12">

		<!--REPORT -->
<axsl:if test="true()">***report|extractedActionName|urn:nhs:names:services:pds/QUPA_IN040000UK01***<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN ReportMessageID-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:id" priority="1000" mode="M13">
...
<!--PATTERN ReportAuthorAuthor-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActProcess/hl7:author/hl7:assignedEntity" priority="1000" mode="M14">
...
<!--PATTERN ReportRQDetails-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActProcess[1]/hl7:pdsRetrievalQuery" priority="1000" mode="M15">

		<!--REPORT -->
<axsl:if test="count(hl7:person.id/hl7:value)=1">***report|nhsNumber|<axsl:text/><axsl:value-of select="hl7:person.id/hl7:value/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|hdIndicator|<axsl:text/><axsl:value-of select="hl7:historicDataIndicator/hl7:value/@code"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|retrievalItem1|<axsl:text/><axsl:value-of select="hl7:retrievalItem[1]/hl7:semanticsText"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M15"/></axsl:template><axsl:template match="text()" priority="-1" mode="M15"/><axsl:template match="@*|node()" priority="-2" mode="M15"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M15"/></axsl:template></axsl:stylesheet>
