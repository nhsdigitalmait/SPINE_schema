...
<!--SCHEMA METADATA-->
<axsl:template match="/"><axsl:apply-templates select="/" mode="M4"/><axsl:apply-templates select="/" mode="M5"/><axsl:apply-templates select="/" mode="M6"/><axsl:apply-templates select="/" mode="M7"/><axsl:apply-templates select="/" mode="M8"/><axsl:apply-templates select="/" mode="M9"/><axsl:apply-templates select="/" mode="M10"/><axsl:apply-templates select="/" mode="M11"/><axsl:apply-templates select="/" mode="M12"/></axsl:template>
...
<!--PATTERN soapSchema-->
	...
	<!--RULE -->
<axsl:template match="/" priority="1000" mode="M4">
...
<!--PATTERN BodyChecks-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]" priority="1000" mode="M6">
...
<!--PATTERN HeaderToBodyCompare-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]" priority="1000" mode="M7">
...
<!--PATTERN AuthorCheck-Person-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:author" priority="1000" mode="M8">
...
<!--PATTERN AuthorCheck-System1-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:author1[1]/hl7:AgentSystemSDS/hl7:agentSystemSDS" priority="1000" mode="M9">
...
<!--PATTERN AuthorCheck-System2-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:author1[2]/hl7:AgentSystemSDS/hl7:agentSystemSDS" priority="1000" mode="M10">
...
<!--PATTERN extractQuery-->


	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*/hl7:ControlActEvent[1]/hl7:query[1]" priority="1000" mode="M12">

		<!--REPORT -->
<axsl:if test="count(hl7:prescriptionId/@value) &gt; 0">***report|prescriptionID|<axsl:text/><axsl:value-of select="hl7:prescriptionId/@value"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:patientId/@value) &gt; 0">***report|nhsNumber|<axsl:text/><axsl:value-of select="hl7:patientId/@value"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:dispenserOrganisation/@value) &gt; 0">***report|dispenserOrg|<axsl:text/><axsl:value-of select="hl7:dispenserOrganisation/@value"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:prescriberOrganisation/@value) &gt; 0">***report|prescriberOrg|<axsl:text/><axsl:value-of select="hl7:prescriberOrganisation/@value"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:releaseVersion/@value) &gt; 0">***report|releaseVersion|<axsl:text/><axsl:value-of select="hl7:releaseVersion/@value"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:prescriptionStatus/@value) &gt; 0">***BEGIN-LIST-ENTRY|report|prescriptionStatus***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:prescriptionStatus/@value) &gt; 0">+++prescriptionStatus|<axsl:text/><axsl:value-of select="hl7:prescriptionStatus/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:prescriptionStatus/@value) &gt; 0">***END-LIST-ENTRY***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:creationDateRange/hl7:value/hl7:window/hl7:low/@value) &gt; 0">***report|creationDateLow|<axsl:text/><axsl:value-of select="hl7:creationDateRange/hl7:value/hl7:window/hl7:low/@value"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:creationDateRange/hl7:value/hl7:window/hl7:high/@value) &gt; 0">***report|creationDateHigh|<axsl:text/><axsl:value-of select="hl7:creationDateRange/hl7:value/hl7:window/hl7:high/@value"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M12"/></axsl:template><axsl:template match="text()" priority="-1" mode="M12"/><axsl:template match="@*|node()" priority="-2" mode="M12"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M12"/></axsl:template></axsl:stylesheet>
