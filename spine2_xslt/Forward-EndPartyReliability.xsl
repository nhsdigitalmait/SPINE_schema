...
<axsl:choose><axsl:when test="count(eb:SyncReply) = 0"/><axsl:otherwise>***fault|ErrorBaseTms.SYNCREPLY_INCONSISTENT_WITH_CONTRACT***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(eb:AckRequested) = 1"/><axsl:otherwise>***fault|ErrorBaseTms.SYNCREPLY_INCONSISTENT_WITH_CONTRACT***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="eb:AckRequested/@eb:version = '2.0'"/><axsl:otherwise>***fault|ErrorBaseTms.SYNCREPLY_VERSION_INVALID***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="eb:AckRequested/@eb:signed = 'false'"/><axsl:otherwise>***fault|ErrorBaseTms.SYNCREPLY_VERSION_INVALID***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="eb:AckRequested/@SOAP:actor = 'urn:oasis:names:tc:ebxml-msg:actor:toPartyMSH'"/><axsl:otherwise>***fault|ErrorBaseTms.SYNCREPLY_VERSION_INVALID***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
