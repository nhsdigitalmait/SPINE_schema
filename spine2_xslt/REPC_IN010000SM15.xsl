...
<!--PATTERN BodyChecks-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*" priority="1000" mode="M11"><axsl:variable name="MessageGUID" select="hl7:id/@root"/><axsl:variable name="InteractionID" select="hl7:interactionId/@extension"/><axsl:variable name="SenderAsid" select="hl7:communicationFunctionSnd/hl7:device/hl7:id/@extension"/>
...
<!--PATTERN PTVCreateBodyCheck-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*" priority="1000" mode="M12">

		<!--REPORT -->
<axsl:if test="count(hl7:ControlActEvent/hl7:subject/hl7:CreateRequest)">***report|containsLegitimateRelationship|yes***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:ControlActEvent/hl7:CreatePermissionToView)">***report|containsPermissionToView|yes***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M12"/></axsl:template><axsl:template match="text()" priority="-1" mode="M12"/><axsl:template match="@*|node()" priority="-2" mode="M12"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M12"/></axsl:template>

<!--PATTERN structureChecks-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:CreatePermissionToView" priority="1000" mode="M13">

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:subject)=1"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_REQUEST[Permission To View requires subject to be present]|validation error subject element is mandatory***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M13"/></axsl:template><axsl:template match="text()" priority="-1" mode="M13"/><axsl:template match="@*|node()" priority="-2" mode="M13"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M13"/></axsl:template>

<!--PATTERN CreateRequest-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest" priority="1000" mode="M14">
...
<!--PATTERN CreateRequest-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest" priority="1000" mode="M15">
...
<!--PATTERN AuthorElementCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest/hl7:author" priority="1000" mode="M16"><axsl:variable name="authorUserCount" select="count(hl7:AgentPerson)"/><axsl:variable name="authorUserRPRootCount" select="count(hl7:AgentPerson/hl7:id[@root])"/><axsl:variable name="authorSystemCount" select="count(hl7:AgentDeviceSDS)"/><axsl:variable name="authorUserIdCount" select="count(hl7:AgentPerson/hl7:agentPersonSDS/hl7:id)"/><axsl:variable name="authorUserRPIdCount" select="count(hl7:AgentPerson/hl7:id)"/><axsl:variable name="authorSystemDeviceIdCount" select="count(hl7:AgentDeviceSDS/hl7:agentDeviceSDS/hl7:id)"/>
...
<!--PATTERN SubjectElementCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest/hl7:subject" priority="1000" mode="M17"><axsl:variable name="subjectUserCount" select="count(hl7:AgentPersonSDS)"/><axsl:variable name="subjectWorkgroupCount" select="count(hl7:AgentOrgSDS)"/>

		<!--ASSERT -->
<axsl:choose><axsl:when test="$subjectUserCount + $subjectWorkgroupCount &gt; 0"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_SUBJECT_ELEMENT[atLeastOneUserOrWorkgroup]|validation error - either a subject user or workgroup must be provided***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M17"/></axsl:template><axsl:template match="text()" priority="-1" mode="M17"/><axsl:template match="@*|node()" priority="-2" mode="M17"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M17"/></axsl:template>

<!--PATTERN LrTypeCheck-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest" priority="1000" mode="M18">
...
<!--PATTERN SubjectUserCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest/hl7:subject/hl7:AgentPersonSDS" priority="1000" mode="M19">
...
<!--PATTERN patient checks-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest/hl7:recordTarget" priority="1000" mode="M20"><axsl:variable name="patientIDCount" select="count(hl7:patient)"/><axsl:variable name="patientID" select="hl7:patient/hl7:id/@extension"/><axsl:variable name="patientIdOID" select="hl7:patient/hl7:id/@root"/><axsl:variable name="patientIdOIDCount" select="count(hl7:patient/hl7:id[@root='2.16.840.1.113883.2.1.4.1'])"/>
...
<!--PATTERN workgroupsCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest/hl7:subject/hl7:AgentOrgSDS" priority="1000" mode="M21">
...
<!--PATTERN workgroupsReport-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest/hl7:subject/hl7:AgentOrgSDS" priority="1000" mode="M22">
...
<!--PATTERN CreateRequest.author AgentPerson elements-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest/hl7:author/hl7:AgentPerson" priority="1000" mode="M23">
...
<!--PATTERN CreateRequest.author.AgentPerson.representedOrganization elements-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest/hl7:author/hl7:AgentPerson/hl7:representedOrganization" priority="1000" mode="M24">
...
<!--PATTERN CreateRequest.author.AgentDeviceSDS elements-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest/hl7:author/hl7:AgentDeviceSDS" priority="1000" mode="M25">
...
<!--PATTERN CreateRequest.pertinentInformation.pertinentLRReason attributes-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest/hl7:pertinentInformation" priority="1000" mode="M26">
...
<!--PATTERN CreateRequest.reason attributes-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest/hl7:reason" priority="1000" mode="M27">
...
<!--PATTERN ptvAuthorElementCheck-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:CreatePermissionToView/hl7:author" priority="1000" mode="M28"><axsl:variable name="authorUserCount" select="count(hl7:AgentPerson)"/><axsl:variable name="authorUserRPRootCount" select="count(hl7:AgentPerson/hl7:id[@root])"/><axsl:variable name="authorSystemCount" select="count(hl7:AgentDeviceSDS)"/><axsl:variable name="authorUserIdCount" select="count(hl7:AgentPerson/hl7:agentPersonSDS/hl7:id)"/><axsl:variable name="authorUserRPIdCount" select="count(hl7:AgentPerson/hl7:id)"/><axsl:variable name="authorSystemDeviceIdCount" select="count(hl7:AgentDeviceSDS/hl7:agentDeviceSDS/hl7:id)"/>
...
<!--PATTERN CreatePermissionToViewReport-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:CreatePermissionToView" priority="1000" mode="M29">

		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.effectiveTime|<axsl:text/><axsl:value-of select="hl7:effectiveTime/@value"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.lrTypeCode|<axsl:text/><axsl:value-of select="hl7:reasonCode/@code"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.lrTypeCodeSystem|<axsl:text/><axsl:value-of select="hl7:reasonCode/@codeSystem"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M29"/></axsl:template><axsl:template match="text()" priority="-1" mode="M29"/><axsl:template match="@*|node()" priority="-2" mode="M29"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M29"/></axsl:template>

<!--PATTERN CreatePermissionToView-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:CreatePermissionToView" priority="1000" mode="M30">
...
<!--PATTERN SubjectElementCheck PermissionToView-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:CreatePermissionToView/hl7:subject" priority="1000" mode="M31"><axsl:variable name="subjectUserCount" select="count(hl7:AgentPersonSDS)"/><axsl:variable name="subjectWorkgroupCount" select="count(hl7:AgentOrgSDS)"/><axsl:variable name="subjectUserIdCount" select="count(hl7:AgentPersonSDS/hl7:agentPersonSDS/hl7:id)"/><axsl:variable name="subjectUserRPIdCount" select="count(hl7:AgentPersonSDS/hl7:id)"/>

		<!--ASSERT -->
<axsl:choose><axsl:when test="$subjectUserCount + $subjectWorkgroupCount &gt;= 1"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_SUBJECT_ELEMENT[subject must contain either a user or a workgroup]|validation error***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="$subjectUserIdCount + $subjectWorkgroupCount &gt;= 1"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_SUBJECT_USER_ID_MISSING[subject must contain either a user ID or a workgroup]|validation error***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="$subjectUserRPIdCount + $subjectWorkgroupCount &gt;= 1"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_SUBJECT_URPID_MISSING[subject must contain either a user Role Profile ID or a workgroup]|validation error***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M31"/></axsl:template><axsl:template match="text()" priority="-1" mode="M31"/><axsl:template match="@*|node()" priority="-2" mode="M31"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M31"/></axsl:template>

<!--PATTERN SubjectUserCheckPermissionToView-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:CreatePermissionToView/hl7:subject/hl7:AgentPersonSDS" priority="1000" mode="M32">
...
<axsl:choose><axsl:when test="string-length(hl7:agentPersonSDS/hl7:id/@extension)&lt;=12"/><axsl:otherwise>***fault|ErrorBase1712.USER_ID_TOO_LONG[subjectUserRoleIdTooLong]|<axsl:text/><axsl:value-of select="hl7:agentPersonSDS/hl7:id/@extension"/><axsl:text/>|12***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.person.roleProfileId.codeSystem|<axsl:text/><axsl:value-of select="hl7:id/@root"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.person.roleProfileId.code|<axsl:text/><axsl:value-of select="hl7:id/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.person.sdsPersonId.codeSystem|<axsl:text/><axsl:value-of select="hl7:agentPersonSDS/hl7:id/@root"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.person.sdsPersonId.code|<axsl:text/><axsl:value-of select="hl7:agentPersonSDS/hl7:id/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M32"/></axsl:template><axsl:template match="text()" priority="-1" mode="M32"/><axsl:template match="@*|node()" priority="-2" mode="M32"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M32"/></axsl:template>

<!--PATTERN patient checksPermissionToView-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:CreatePermissionToView/hl7:recordTarget" priority="1000" mode="M33"><axsl:variable name="patientIDCount" select="count(hl7:patient)"/><axsl:variable name="patientID" select="hl7:patient/hl7:id/@extension"/><axsl:variable name="patientIdOID" select="hl7:patient/hl7:id/@root"/><axsl:variable name="patientIdOIDCount" select="count(hl7:patient/hl7:id[@root='2.16.840.1.113883.2.1.4.1'])"/>
...
<axsl:choose><axsl:when test="$patientIdOIDCount=1"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_OID|PatientOID|<axsl:text/><axsl:value-of select="$patientIdOID"/><axsl:text/>|2.16.840.1.113883.2.1.4.1***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.nhsNumberCodeSystem|<axsl:text/><axsl:value-of select="hl7:patient/hl7:id/@root"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.nhsNumberCode|<axsl:text/><axsl:value-of select="hl7:patient/hl7:id/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M33"/></axsl:template><axsl:template match="text()" priority="-1" mode="M33"/><axsl:template match="@*|node()" priority="-2" mode="M33"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M33"/></axsl:template>

<!--PATTERN ptvWorkgroupsCheck-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:CreatePermissionToView/hl7:subject/hl7:AgentOrgSDS" priority="1000" mode="M34">
...
<!--PATTERN ptvWorkgroupsReport-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:CreatePermissionToView/hl7:subject/hl7:AgentOrgSDS" priority="1000" mode="M35">

		<!--REPORT -->
<axsl:if test="count(hl7:code/@code) = 1">***report|workgroup.organisation.code|<axsl:text/><axsl:value-of select="hl7:AgentOrgSDS/hl7:code/@code"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:variable name="subjectWorkgroupCount" select="count(hl7:agentOrganizationSDS/hl7:id)"/><axsl:variable name="subjectWorkgroupId" select="hl7:agentOrganizationSDS/hl7:id/@extension"/>

		<!--REPORT -->
<axsl:if test="true()">***BEGIN-LIST-ENTRY|report|permissionToViewWorkgroup***<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN CreatePermissionToView.subject.UserAndWorkgroups-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:CreatePermissionToView/hl7:subject" priority="1000" mode="M36">

		<!--REPORT -->
<axsl:if test="count(hl7:AgentPersonSDS) &gt; 0 and count(hl7:AgentOrgSDS) &gt; 0">***fault|ErrorBase1712.INVALID_SUBJECT_ELEMENT|validation error - user and workgroups present***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M36"/></axsl:template><axsl:template match="text()" priority="-1" mode="M36"/><axsl:template match="@*|node()" priority="-2" mode="M36"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M36"/></axsl:template>

<!--PATTERN CreatePermissionToView.subject.AgentPersonSDS.id-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:CreatePermissionToView/hl7:subject/hl7:AgentPersonSDS" priority="1000" mode="M37">
...
<axsl:choose><axsl:when test="string-length(hl7:agentPersonSDS/hl7:id/@extension)&lt;=12"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_AUTHOR_USER_ID_TOO_LONG[authorIDTooLong]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.author.person.SDSPerson.codeSystem|<axsl:text/><axsl:value-of select="hl7:agentPersonSDS/hl7:id/@root"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.author.person.SDSPerson.code|<axsl:text/><axsl:value-of select="hl7:agentPersonSDS/hl7:id/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.author.person.roleProfile.codeSystem|<axsl:text/><axsl:value-of select="hl7:id/@root"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.author.person.roleProfile.code|<axsl:text/><axsl:value-of select="hl7:id/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN CreatePermissionToView.author AgentPerson elements-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:CreatePermissionToView/hl7:author/hl7:AgentPerson" priority="1000" mode="M38">
...
<!--PATTERN CreatePermissionToView.author.AgentPerson.representedOrganization elements-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest/hl7:author/hl7:AgentPerson/hl7:representedOrganization" priority="1000" mode="M39">
...
<axsl:choose><axsl:when test="count(hl7:id/@extension) = count(hl7:id)"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_REQUEST[missingWorkgroupID]|validation error***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--REPORT -->
<axsl:if test="true()">***BEGIN-LIST-ENTRY|report|permissionToView.workgroupcodeContainer***<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN CreatePermissionToView.author.AgentDeviceSDS elements-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:CreatePermissionToView/hl7:author/hl7:AgentDeviceSDS" priority="1000" mode="M40">
...
<axsl:choose><axsl:when test="string-length(hl7:agentDeviceSDS/hl7:id/@extension) &gt; 0"/><axsl:otherwise>***fault|ErrorBase1712.SYSTEM_ID_EMPTY[authorDeviceIDEmpty]|validation error***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.author.system.codeSystem|<axsl:text/><axsl:value-of select="hl7:agentDeviceSDS/hl7:id/@root"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.author.system.code|<axsl:text/><axsl:value-of select="hl7:agentDeviceSDS/hl7:id/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M40"/></axsl:template><axsl:template match="text()" priority="-1" mode="M40"/><axsl:template match="@*|node()" priority="-2" mode="M40"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M40"/></axsl:template>

<!--PATTERN CreatePermissionToView.pertinentInformation.pertinentLRReason attributes-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest/hl7:pertinentInformation" priority="1000" mode="M41">
...
<axsl:choose><axsl:when test="count(hl7:pertinentLRReason) = 1"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_REQUEST[lr reason must be provided]|validation error***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.pertinentInformation.pertinentLRReason.text|<axsl:text/><axsl:value-of select="hl7:pertinentLRReason/hl7:text"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.pertinentInformation.pertinentLRReason.reasonCode|<axsl:text/><axsl:value-of select="hl7:pertinentLRReason/hl7:reasonCode/@code"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.pertinentInformation.pertinentLRReason.reasonCodeSystem|<axsl:text/><axsl:value-of select="hl7:pertinentLRReason/hl7:reasonCode/@codeSystem"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M41"/></axsl:template><axsl:template match="text()" priority="-1" mode="M41"/><axsl:template match="@*|node()" priority="-2" mode="M41"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M41"/></axsl:template>

<!--PATTERN CreatePermissionToView.reason attributes-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent/hl7:subject/hl7:CreateRequest/hl7:reason" priority="1000" mode="M42">
...
<axsl:choose><axsl:when test="count(hl7:justifyingAlertRequest/hl7:code[@codeSystem='2.16.840.1.113883.2.1.3.2.4.17.8']) = 1"/><axsl:otherwise>***fault|ErrorBase1712.INVALID_REQUEST[reasonAlertCodeSystemIncorrect]|validation error***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.accessReason.codeSystem|<axsl:text/><axsl:value-of select="hl7:justifyingAlertRequest/hl7:code/@codeSystem"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|permissionToView.accessReason.code|<axsl:text/><axsl:value-of select="hl7:justifyingAlertRequest/hl7:code/@code"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M42"/></axsl:template><axsl:template match="text()" priority="-1" mode="M42"/><axsl:template match="@*|node()" priority="-2" mode="M42"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M42"/></axsl:template>

<!--PATTERN CreatePermissionToViewChecks-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:REPC_IN010000SM15/hl7:ControlActEvent" priority="1000" mode="M43"><axsl:variable name="LR_patientCount" select="count(hl7:CreateRequest/hl7:recordTarget/hl7:patient/hl7:id)"/><axsl:variable name="PTV_patientCount" select="count(hl7:CreatePermissionToView/hl7:recordTarget/hl7:patient/hl7:id)"/><axsl:variable name="LR_patient" select="hl7:CreateRequest/hl7:recordTarget/hl7:patient/hl7:id/@extension"/><axsl:variable name="PTV_patient" select="hl7:CreatePermissionToView/hl7:recordTarget/hl7:patient/hl7:id/@extension"/>

		<!--REPORT -->
<axsl:if test="($LR_patientCount=1 and $PTV_patientCount=1) and ($LR_patient!=$PTV_patient)">***fault|ErrorBase1712.INVALID_REQUEST|validation error Nhs Numbers do not match***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M43"/></axsl:template><axsl:template match="text()" priority="-1" mode="M43"/><axsl:template match="@*|node()" priority="-2" mode="M43"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M43"/></axsl:template></axsl:stylesheet>
