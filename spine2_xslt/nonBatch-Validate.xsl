...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:sch="http://www.ascc.net/xml/schematron" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:SOAP="http://schemas.xmlsoap.org/soap/envelope/" xmlns:hl7="urn:hl7-org:v3" xmlns:crs="http://national.carerecords.nhs.uk/schema/crs/" version="1.0"><!--Implementers: please note that overriding process-prolog or process-root is 
...
<axsl:if test="true()">***report|fromASID|<axsl:text/><axsl:value-of select="hl7:communicationFunctionSnd/hl7:device/hl7:id[@root='1.2.826.0.1285.0.2.0.107']/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="count(hl7:ControlActEvent/hl7:subject/*/hl7:id)=1">***report|eventID|<axsl:text/><axsl:value-of select="hl7:ControlActEvent/hl7:subject/*/hl7:id/@root"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:ControlActEvent/hl7:query/*/hl7:id)=1">***report|eventID|<axsl:text/><axsl:value-of select="hl7:ControlActEvent/hl7:query/*/hl7:id/@root"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:ControlActEvent/crs:*/*/hl7:id)=1">***report|eventID|<axsl:text/><axsl:value-of select="hl7:ControlActEvent/crs:*/*/hl7:id/@root"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M3"/></axsl:template><axsl:template match="text()" priority="-1" mode="M3"/><axsl:template match="@*|node()" priority="-2" mode="M3"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M3"/></axsl:template>

<!--PATTERN ControlActChecks-->


	<!--RULE -->
<axsl:template match="/*[1]/hl7:ControlActEvent[1]" priority="1000" mode="M4">
...
<!--PATTERN AuthorCheck-Person-->
	...
	<!--RULE -->
<axsl:template match="/*[1]/hl7:ControlActEvent[1]/hl7:author" priority="1000" mode="M5">
...
<axsl:if test="true()">***report|agentPersonSDSRole|<axsl:text/><axsl:value-of select="hl7:AgentPersonSDS/hl7:id[@root='1.2.826.0.1285.0.2.0.67']/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="true()">***report|agentPersonSDSRoleCodeSystem|<axsl:text/><axsl:value-of select="hl7:AgentPersonSDS/hl7:id[@root='1.2.826.0.1285.0.2.0.67']/@root"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN AuthorCheck-System1-->
	...
	<!--RULE -->
<axsl:template match="/*[1]/hl7:ControlActEvent[1]/hl7:author1[1]/hl7:AgentSystemSDS/hl7:agentSystemSDS" priority="1000" mode="M6">
...
<!--PATTERN AuthorCheck-System2-->
	...
	<!--RULE -->
<axsl:template match="/*[1]/hl7:ControlActEvent[1]/hl7:author1[2]/hl7:AgentSystemSDS/hl7:agentSystemSDS" priority="1000" mode="M7">
...
<!--PATTERN BodyExists-->
	...
	<!--RULE -->
<axsl:template match="/*[1]/hl7:ControlActEvent[1]" priority="1000" mode="M8">

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:query)=1 or count(hl7:subject)=1 or count(crs:setResourcePermissionsRequest)=1 or count(hl7:CreateRequest)=1 or count(hl7:SCRequest)=1"/><axsl:otherwise>***fault|ErrorBase1732.CONTROL_ACT_MANDATORY_ELEMENT_MISSING***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:query)=1 or count(crs:setResourcePermissionsRequest)=1 or count(hl7:subject/hl7:*)&gt;0 or count(hl7:CreateRequest)=1 or count(hl7:SCRequest)=1"/><axsl:otherwise>***fault|ErrorBase1732.CONTROL_ACT_MANDATORY_ELEMENT_MISSING***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M8"/></axsl:template><axsl:template match="text()" priority="-1" mode="M8"/><axsl:template match="@*|node()" priority="-2" mode="M8"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M8"/></axsl:template></axsl:stylesheet>
