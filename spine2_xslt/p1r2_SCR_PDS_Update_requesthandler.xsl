...
<!--SCHEMA METADATA-->
<axsl:template match="/"><axsl:apply-templates select="/" mode="M5"/><axsl:apply-templates select="/" mode="M6"/><axsl:apply-templates select="/" mode="M7"/><axsl:apply-templates select="/" mode="M8"/><axsl:apply-templates select="/" mode="M9"/><axsl:apply-templates select="/" mode="M10"/><axsl:apply-templates select="/" mode="M11"/></axsl:template>
...
<!--PATTERN BodyChecks-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]" priority="1000" mode="M7">
...
<!--PATTERN nhsNumberCheck-->
	...
	<!--RULE -->
<axsl:template match="hl7:PRPA_IN000203SM03/hl7:ControlActEvent[1]/hl7:PdsUpdateRequest/hl7:subject/hl7:patientRole" priority="1000" mode="M8">
...
<!--PATTERN AuthorCheck-System1-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:author1[1]" priority="1000" mode="M10">
...
<axsl:if test="count(hl7:AgentSystemSDS/hl7:agentSystemSDS/hl7:id[@root='1.2.826.0.1285.0.2.0.107'])=1">***report|agentSystemSDS1|<axsl:text/><axsl:value-of select="hl7:AgentSystemSDS/hl7:agentSystemSDS/hl7:id[@root='1.2.826.0.1285.0.2.0.107']/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="count(hl7:AgentSystemSDS/hl7:agentSystemSDS/hl7:id[@root='1.2.826.0.1285.0.2.0.107'])=1">***report|agentSystemSDS1CodeSystem|<axsl:text/><axsl:value-of select="hl7:AgentSystemSDS/hl7:agentSystemSDS/hl7:id[@root='1.2.826.0.1285.0.2.0.107']/@root"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template><axsl:template match="text()" priority="-1" mode="M10"/><axsl:template match="@*|node()" priority="-2" mode="M10"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></axsl:template>
...
<axsl:template match="SOAP:Envelope[1]/SOAP:Header[1]" priority="1000" mode="M11">
		...
		<!--REPORT -->
<axsl:if test="string-length(wsa:Action[1])&gt;0">***report|extractedActionName|<axsl:text/><axsl:value-of select="wsa:Action[1]"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M11"/></axsl:template><axsl:template match="text()" priority="-1" mode="M11"/><axsl:template match="@*|node()" priority="-2" mode="M11"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M11"/></axsl:template></axsl:stylesheet>
