...
<!--PATTERN systemInformationCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:*/hl7:ControlActEvent/hl7:author1/hl7:AgentSystemSDS" priority="1000" mode="M9">
...
<!--PATTERN payloadID-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:*" priority="1000" mode="M10">
