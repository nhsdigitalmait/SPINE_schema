...
<!--PATTERN AttachmentReference-->


	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/eb:Manifest[1]/eb:Reference" priority="1000" mode="M6">

		<!--REPORT -->
<axsl:if test="true()">***BEGIN-LIST-ENTRY|report|contentIDList***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++contentID|<axsl:text/><axsl:value-of select="@xlink:href"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
