...
<!--SCHEMA METADATA-->
<axsl:template match="/"><axsl:apply-templates select="/" mode="M1"/><axsl:apply-templates select="/" mode="M2"/><axsl:apply-templates select="/" mode="M3"/><axsl:apply-templates select="/" mode="M4"/><axsl:apply-templates select="/" mode="M5"/><axsl:apply-templates select="/" mode="M6"/><axsl:apply-templates select="/" mode="M7"/><axsl:apply-templates select="/" mode="M8"/></axsl:template>

<!--SCHEMATRON PATTERNS-->


<!--PATTERN basic layout - check that there are not >1 fields of each type-->
...
<!--PATTERN birthTimeCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:person.birthTime" priority="1000" mode="M3">
...
<!--PATTERN deceasedTimeCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:person.deceasedTime" priority="1000" mode="M4">
...
<!--PATTERN nhsNumberCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:person.id" priority="1000" mode="M5">
...
<!--PATTERN nameReport-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:person.name" priority="1000" mode="M6">
...
<!--PATTERN addressReport-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:person.address" priority="1000" mode="M7">
...
<!--PATTERN primaryCareCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent/hl7:query/hl7:primaryCare.id" priority="1000" mode="M8">
