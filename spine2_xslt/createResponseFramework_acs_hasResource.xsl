...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <SOAP-ENV:Envelope xmlns:crs="http://national.carerecords.nhs.uk/schema/crs/" xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:wsa="http://schemas.xmlsoap.org/ws/2004/08/addressing" xmlns="urn:hl7-org:v3" xmlns:hl7="urn:hl7-org:v3">
            ...
            <SOAP-ENV:Body>
                <hasResourcePermissionsResponse xmlns="urn:hl7-org:v3">
                    <xsl:element name="{$responseAction}">
                        ...
                        <ControlActEvent classCode="CACT" moodCode="EVN">
                            ...
                            <xsl:if test="$detectedIssueCode5='true' or $detectedIssueCode9='true' or $detectedIssueCode24='true'">
                                <reason typeCode="RSON">
                                    ...
                                    <xsl:if test="$detectedIssueCode5='true'">
                                        <justifyingDetectedIssueEvent classCode="ALRT"
                                            moodCode="EVN">
                                            <code codeSystem="2.16.840.1.113883.2.1.3.2.4.17.42" code="5"
                                                name="Match - NHS Number and limited data only returned (sensitivity conditions apply)">
                                                <qualifier code="WG" />
                                            </code>
                                    ...
                                    <xsl:if test="$detectedIssueCode9='true'">
                                        <justifyingDetectedIssueEvent classCode="ALRT"
                                            moodCode="EVN">
                                            <code codeSystem="2.16.840.1.113883.2.1.3.2.4.17.42" code="9"
                                                name="Successful retrieval - Information returned limited by sensitivity conditions">
                                                <qualifier code="WG" />
                                            </code>
                                        </justifyingDetectedIssueEvent>
                                    </xsl:if>
                                    ...
                                    <xsl:if test="$detectedIssueCode24='true'">
                                        <justifyingDetectedIssueEvent classCode="ALRT"
                                            moodCode="EVN">
                                            <code codeSystem="2.16.840.1.113883.2.1.3.2.4.17.42" code="24"
                                                name="NHS Number supplied as a parameter has been superseded and superseding NHS Number returned">
                                                <qualifier code="WG" />
                                            </code>
                                        </justifyingDetectedIssueEvent>
                                    </xsl:if>
                            ...
                            <xsl:if test="$responseAction != 'MCCI_IN010000UK13'">
                            ...
                            <xsl:if test="$responseAction = 'MCCI_IN010000UK13'">
                            <queryAck type="QueryAck">
                                <queryResponseCode name="acs specific 2" code="OK" />
                                <!-- Something else -->
                            </queryAck>
                            </xsl:if>
                ...
                </hasResourcePermissionsResponse>
            </SOAP-ENV:Body>
        </SOAP-ENV:Envelope>
