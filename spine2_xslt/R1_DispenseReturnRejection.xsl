...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        ...
        <hl7:PORX_IN240101UK04 xmlns:hl7="urn:hl7-org:v3">
            <hl7:id>
            ...
            <hl7:interactionId root="2.16.840.1.113883.2.1.3.2.4.12" extension="PORX_IN240101UK04"/>
            ...
            <hl7:ControlActEvent classCode="CACT" moodCode="EVN">
                ...
                <hl7:subject>
                    <hl7:DispenseReturnReject xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ../Schemas/PORX_MT121302UK04.xsd" classCode="ADJUD" moodCode="EVN" type="ActHeir">
                        <hl7:id>
                            <xsl:attribute name="root">
                                <xsl:value-of select="$messageID"/>
                            </xsl:attribute>
                        ...
                        <hl7:pertinentInformation1 typeCode="PERT" type="ActRelationship">
                            <hl7:pertinentDispenseReturnRejectionReason classCode="OBS" moodCode="EVN" type="Observation">
                                <xsl:for-each select="//pyxs:col[@type='dict']" xmlns:pyxs="http://projects.coder.cl/pyxser/model/">
                                    <hl7:code codeSystem="2.16.840.1.113883.2.1.3.2.4.17.30" code="DRRR"/>
                                    <hl7:text>
                            ...
                            </hl7:pertinentDispenseReturnRejectionReason>
                        </hl7:pertinentInformation1>
                        <hl7:pertinentInformation2 typeCode="PERT" type="ActRelationship">
                            <hl7:pertinentDispenseProposalReturnRef classCode="INFO" moodCode="EVN" type="ControlAct">
                                <hl7:id>
                                    <xsl:attribute name="root">
                                        <xsl:value-of select="$refToEventID"/>
                                    </xsl:attribute>
                                </hl7:id>
                            </hl7:pertinentDispenseProposalReturnRef>
                        </hl7:pertinentInformation2>
                    </hl7:DispenseReturnReject>
                </hl7:subject>
            </hl7:ControlActEvent>
        </hl7:PORX_IN240101UK04>
