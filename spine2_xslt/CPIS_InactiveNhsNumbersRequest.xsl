...
<!--SCHEMA METADATA-->
<axsl:template match="/"><axsl:apply-templates select="/" mode="M3"/><axsl:apply-templates select="/" mode="M4"/></axsl:template>

<!--SCHEMATRON PATTERNS-->


<!--PATTERN HeaderReport-->


	<!--RULE -->
<axsl:template match="SOAP:Envelope/SOAP:Header" priority="1000" mode="M3">

		<!--REPORT -->
<axsl:if test="true()">***report|extractedActionName|urn:nhs:names:services:cpisquery/INACTIVE_NHS_NUMBERS***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|interactionID|INACTIVE_NHS_NUMBERS***<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN QueryParametersReport-->


	<!--RULE -->
<axsl:template match="SOAP:Envelope/SOAP:Body/hl7:INACTIVE_NHS_NUMBERS" priority="1000" mode="M4">

		<!--REPORT -->
<axsl:if test="true()">***report|messageID|<axsl:text/><axsl:value-of select="hl7:id/@root"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|localAuthority.id|<axsl:text/><axsl:value-of select="hl7:LocalAuthority/@id"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|localAuthority.name|<axsl:text/><axsl:value-of select="hl7:LocalAuthority/@name"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|accessTime.low|<axsl:text/><axsl:value-of select="hl7:AccessTime/@low"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|accessTime.high|<axsl:text/><axsl:value-of select="hl7:AccessTime/@high"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/></axsl:template><axsl:template match="text()" priority="-1" mode="M4"/><axsl:template match="@*|node()" priority="-2" mode="M4"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/></axsl:template></axsl:stylesheet>
