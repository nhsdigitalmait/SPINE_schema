...
<!--PATTERN relatedPersonCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject/hl7:patientRole/hl7:patientPerson/hl7:scopedRelatedPersonRole[@updateMode='removed']" priority="1001" mode="M3">
...
<axsl:if test="$nhsNumberIDCount=0 and not($addrCount=1)">***fault|ErrorBase1742.RELATED_PERSON_NAME_ADDRESS_MISSING[scopedRelatedPersonRole.address]***<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="$nhsNumberIDCount=0 and not($nameCount=1)">***fault|ErrorBase1742.RELATED_PERSON_NAME_ADDRESS_MISSING[scopedRelatedPersonRole.name]***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M3"/></axsl:template><axsl:template match="text()" priority="-1" mode="M3"/><axsl:template match="@*|node()" priority="-2" mode="M3"><axsl:apply-templates select="@*|*" mode="M3"/></axsl:template>

<!--PATTERN addressCheck-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:addr[@updateMode='removed']" priority="1001" mode="M4">
...
<axsl:choose><axsl:when test="string-length(hl7:id/@extension)&gt;0"/><axsl:otherwise>***fault|ErrorBase1742.UID_MUST_BE_PROVIDED***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M4"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:addr|/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject/hl7:patientRole/hl7:patientPerson/hl7:scopedRelatedPersonRole/hl7:addr" priority="1000" mode="M4">
...
<!--PATTERN telecomCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:telecom[@updateMode='removed']" priority="1001" mode="M5">
...
<axsl:choose><axsl:when test="string-length(hl7:id/@extension)&gt;0"/><axsl:otherwise>***fault|ErrorBase1742.UID_MUST_BE_PROVIDED***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M5"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:telecom|/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject/hl7:patientRole/hl7:patientPerson/hl7:scopedRelatedPersonRole/hl7:telecom" priority="1000" mode="M5">
...
<!--PATTERN nameCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:name[@updateMode='removed']" priority="1001" mode="M6">
...
<axsl:choose><axsl:when test="string-length(hl7:id/@extension)&gt;0"/><axsl:otherwise>***fault|ErrorBase1742.UID_MUST_BE_PROVIDED***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M6"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:name|/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject/hl7:patientRole/hl7:patientPerson/hl7:scopedRelatedPersonRole/hl7:player/hl7:name" priority="1000" mode="M6">
...
<axsl:choose><axsl:when test="string-length(hl7:id/@extension)&gt;0"/><axsl:otherwise>***fault|ErrorBase1742.UID_MUST_BE_PROVIDED***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M7"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson/hl7:playedOtherProviderPatient/hl7:subjectOf[1]/hl7:patientCareProvision[1]" priority="1000" mode="M7"><axsl:variable name="mim63" select="count(/hl7:PRPA_IN000203UK03[1])"/><axsl:variable name="provisionType" select="hl7:code/@code"/>
...
<axsl:choose><axsl:when test="string-length(hl7:code/@code)&gt;0"/><axsl:otherwise>***fault|ErrorBase1742.UNSUPPORTED_PATIENT_CARE***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="$mim63=0 or count(hl7:performer)=1"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING_SUPP_INFO[patientCareProvision.performer]|patientCareProvision.performer***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:variable name="mim63HcpCodeCheck" select="$mim63=1 and count(hl7:performer/hl7:assignedOrganization/hl7:id[@root='2.16.840.1.113883.2.1.4.3'])=1"/><axsl:variable name="otherMimHcpCodeCheck" select="not($mim63=1) and (count(hl7:responsibleParty/hl7:healthCareProvider/hl7:id[@root='2.16.840.1.113883.2.1.4.2'])=1 or count(hl7:responsibleParty/hl7:healthCareProvider/hl7:id[@root='2.16.840.1.113883.2.1.4.3'])=1)"/>

		<!--ASSERT -->
<axsl:choose><axsl:when test="$mim63HcpCodeCheck or $otherMimHcpCodeCheck"/><axsl:otherwise>***fault|ErrorBase1742.UNSUPPORTED_HCP_CODE_TYPE***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<!--PATTERN sharedSecretCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf5/hl7:sharedSecret[1][not(@updateMode='removed')]" priority="1000" mode="M8">
...
<!--PATTERN genderCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:administrativeGenderCode[1][@updateMode='removed']" priority="1000" mode="M9">
...
<!--PATTERN birthTimeCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:birthTime[1][@updateMode='removed']" priority="1000" mode="M10">
...
<!--PATTERN birthOrderCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:multipleBirthOrderNumber[1]" priority="1000" mode="M11">
...
<!--PATTERN interactionSpecificChecks-->
	...
	<!--RULE -->
<axsl:template match="hl7:PRPA_IN160000UK01" priority="1000" mode="M12"><axsl:variable name="updateModedeceasedTime" select="hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:deceasedTime[1]/@updateMode"/><axsl:variable name="updateModedeathNotification" select="hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf7[1]/hl7:deathNotification[1]/@updateMode"/>
...
<!--PATTERN interactionSpecificChecks-->
	...
	<!--RULE -->
<axsl:template match="hl7:PRPA_IN100000UK14" priority="1000" mode="M13"><axsl:variable name="updateModedeceasedTime" select="hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:deceasedTime[1]/@updateMode"/><axsl:variable name="updateModedeathNotification" select="hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf7[1]/hl7:deathNotification[1]/@updateMode"/>
...
<!--PATTERN interactionSpecificChecks-->
	...
	<!--RULE -->
<axsl:template match="hl7:PRPA_IN110000UK15" priority="1000" mode="M14"><axsl:variable name="registeringAuthority" select="count(hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1])"/><axsl:variable name="deceasedTime" select="count(hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:deceasedTime[1])"/><axsl:variable name="deathNotification" select="count(hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf7[1]/hl7:deathNotification[1])"/><axsl:variable name="consent" select="count(hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf1/hl7:consent[1])"/><axsl:variable name="consentValue" select="hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf1/hl7:consent/hl7:code/@code"/>

		<!--REPORT -->
<axsl:if test="($deceasedTime&gt;0)">***fault|ErrorBase1742.DECEASED_TIME_NOT_SUPPORTED***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="($deathNotification&gt;0)">***fault|ErrorBase1742.DEATH_NOTIFICATION_NOT_SUPPORTED***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="($registeringAuthority&gt;0)">***fault|ErrorBase1742.REGISTERING_AUTHORITY_NOT_SUPPORTED***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="($consent&gt;0) and not($consentValue='6')">***fault|ErrorBase1742.CONSENT_VALUE_NOT_SUPPORTED***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M14"/></axsl:template><axsl:template match="text()" priority="-1" mode="M14"/><axsl:template match="@*|node()" priority="-2" mode="M14"><axsl:apply-templates select="@*|*" mode="M14"/></axsl:template>

<!--PATTERN deathUpdateCrossCheck-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]" priority="1000" mode="M15"><axsl:variable name="deceasedTime" select="count(hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:deceasedTime)"/><axsl:variable name="deathNotification" select="count(hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf7[1]/hl7:deathNotification[1])"/><axsl:variable name="author" select="count(hl7:author)"/><axsl:variable name="updateModedeceasedTime" select="hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:deceasedTime[1]/@updateMode"/><axsl:variable name="updateModedeathNotification" select="hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf7[1]/hl7:deathNotification[1]/@updateMode"/>
...
<!--PATTERN deceasedTimeCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:deceasedTime[1]" priority="1000" mode="M16">
...
<!--PATTERN deathNotificationCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf7[1]/hl7:deathNotification[1]" priority="1000" mode="M17">
...
<!--PATTERN registeringAuthorityCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]" priority="1000" mode="M18"><axsl:variable name="mim63" select="count(/hl7:PRPA_IN000203UK03[1])=1"/><axsl:variable name="preMim63" select="not($mim63)"/>

		<!--REPORT -->
<axsl:if test="$preMim63 and count(hl7:representedRegisteringOrganization)=0">***fault|ErrorBase1742.MANDATORY_FIELD_MISSING_SUPP_INFO[registeringAuthority.representedRegisteringOrganization]|registeringAuthority.representedRegisteringOrganization***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$preMim63 and hl7:code/@code='y' and count(hl7:assignedRegisteringPerson)=0">***fault|ErrorBase1742.ASSIGNED_REG_PERSON_MISSING[registeringAuthority.assignedRegisteringPerson]***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$preMim63 and not(hl7:code/@code='y') and count(hl7:assignedRegisteringPerson)&gt;0">***fault|ErrorBase1742.INVALID_ASSIGNED_REGISTERING_PERSON[registeringAuthority.assignedRegisteringPerson]***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$mim63 and hl7:code/@code='y'">***fault|ErrorBase1742.INVALID_REGISTERING_AUTHORITY_TYPE[registeringAuthorityType.code]***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$mim63 and count(hl7:assignedRegisteringPerson)&gt;0">***fault|ErrorBase1742.INVALID_ASSIGNED_REGISTERING_PERSON[registeringAuthority.assignedRegisteringPerson]***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$mim63 and count(hl7:id)=0">***fault|ErrorBase1742.MANDATORY_FIELD_MISSING_SUPP_INFO[registeringAuthority.id]|registeringAuthority.id***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M18"/></axsl:template><axsl:template match="text()" priority="-1" mode="M18"/><axsl:template match="@*|node()" priority="-2" mode="M18"><axsl:apply-templates select="@*|*" mode="M18"/></axsl:template>

<!--PATTERN languageCheck-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:languageCommunication[1]|/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject/hl7:patientRole/hl7:patientPerson/hl7:scopedRelatedPersonRole/hl7:player/hl7:languageCommunication[1]" priority="1000" mode="M19"><axsl:variable name="languageCodeCount" select="count(hl7:languageCode)"/><axsl:variable name="proficiencyLevelCodeCount" select="count(hl7:proficiencyLevelCode)"/><axsl:variable name="preferenceIndCount" select="count(hl7:preferenceInd)"/>
...
<!--PATTERN preferredWrittenCommunicationFormatCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf4[1]/hl7:preferredWrittenCommunicationFormat[1]|/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject/hl7:patientRole/hl7:patientPerson/hl7:scopedRelatedPersonRole/hl7:subjectOf2/hl7:preferredWrittenCommunicationFormat[1]" priority="1000" mode="M20">
...
<!--PATTERN healthspaceRegistrationCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf3[1]/hl7:healthspaceRegistration[1]" priority="1000" mode="M21">
...
<!--PATTERN preferredContactMethodCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf2[1]/hl7:preferredContactMethod[1]|/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject/hl7:patientRole/hl7:patientPerson/hl7:scopedRelatedPersonRole/hl7:subjectOf1[1]/hl7:preferredContactMethod" priority="1000" mode="M22">
...
<!--PATTERN consentCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf1/hl7:consent" priority="1000" mode="M23"><axsl:variable name="mim63" select="count(/SOAP:Envelope/SOAP:Body/hl7:PRPA_IN000203SM03)"/>
...
<axsl:if test="(count(hl7:effectiveTime)&gt;0) and hl7:code/@code='6'">***fault|ErrorBase1742.INVALID_DATA_FOR_CALL_CENTRE_CALL_BACK***<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="(count(hl7:pertinentInformation)&gt;0) and (hl7:code/@code='6' or $mim63=1)">***fault|ErrorBase1742.INVALID_DATA_FOR_CALL_CENTRE_CALL_BACK***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="not(@updateMode='removed') and count(hl7:pertinentInformation/hl7:pertinentSupplementaryComments)&gt;0 and string-length(hl7:pertinentInformation/hl7:pertinentSupplementaryComments/hl7:value)=0">***fault|ErrorBase1742.SUPPLEMENTARY_COMMENTS_VALUE_MISSING***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M23"/></axsl:template><axsl:template match="text()" priority="-1" mode="M23"/><axsl:template match="@*|node()" priority="-2" mode="M23"><axsl:apply-templates select="@*|*" mode="M23"/></axsl:template>

<!--PATTERN birthplaceCheck-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:birthplace[1]" priority="1000" mode="M24"><axsl:variable name="cityCount" select="count(hl7:addr/hl7:city)"/><axsl:variable name="countyCount" select="count(hl7:addr/hl7:county)"/><axsl:variable name="countryCount" select="count(hl7:addr/hl7:country)"/><axsl:variable name="updateMode" select="hl7:addr/@updateMode"/>
...
<axsl:choose><axsl:when test="$updateMode='removed' or $totalElements&gt;0"/><axsl:otherwise>***fault|ErrorBase1742.CITY_COUNTY_COUNTRY_MISSING***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--REPORT -->
<axsl:if test="$updateMode='removed' and $totalElements&gt;0">***fault|ErrorBase1742.BIRTHPLACE_CHANGED_ON_REMOVAL***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M24"/></axsl:template><axsl:template match="text()" priority="-1" mode="M24"/><axsl:template match="@*|node()" priority="-2" mode="M24"><axsl:apply-templates select="@*|*" mode="M24"/></axsl:template>

<!--PATTERN scopedRelatedPersonOutput-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject/hl7:patientRole/hl7:patientPerson/hl7:scopedRelatedPersonRole" priority="1000" mode="M25"><axsl:variable name="mim63" select="count(/SOAP:Envelope/SOAP:Body/hl7:PRPA_IN000203SM03)"/>
...
<axsl:if test="true()">+++position|<axsl:text/><axsl:value-of select="hl7:positionNumber/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="$mim63=0">+++nhsNumber.code|<axsl:text/><axsl:value-of select="hl7:id[@root='2.16.840.1.113883.2.1.4.1']/@extension"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$mim63=0">+++nhsNumber.codeSystem|<axsl:text/><axsl:value-of select="hl7:id[@root='2.16.840.1.113883.2.1.4.1']/@root"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$mim63=1">+++nhsNumber.code|<axsl:text/><axsl:value-of select="hl7:player/hl7:playedRelatedPatient/hl7:id[@root='2.16.840.1.113883.2.1.4.1']/@extension"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$mim63=1">+++nhsNumber.codeSystem|<axsl:text/><axsl:value-of select="hl7:player/hl7:playedRelatedPatient/hl7:id[@root='2.16.840.1.113883.2.1.4.1']//@root"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++correspondence.code|<axsl:text/><axsl:value-of select="hl7:part1/hl7:partCorrespondence/hl7:code/@code|hl7:part/hl7:partCorrespondence/hl7:code/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++correspondence.codeSystem|<axsl:text/><axsl:value-of select="hl7:part1/hl7:partCorrespondence/hl7:code/@codeSystem|hl7:part/hl7:partCorrespondence/hl7:code/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++nextOfKin.code|<axsl:text/><axsl:value-of select="hl7:part2/hl7:partNextOfKin/hl7:code/@code|hl7:part3/hl7:partNextOfKin/hl7:code/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++nextOfKin.codeSystem|<axsl:text/><axsl:value-of select="hl7:part2/hl7:partNextOfKin/hl7:code/@codeSystem|hl7:part3/hl7:partNextOfKin/hl7:code/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:variable name="addrCount" select="count(hl7:addr)=1"/>

		<!--REPORT -->
<axsl:if test="$addrCount=1">+++address/use|<axsl:text/><axsl:value-of select="hl7:addr/@use"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$addrCount=1">+++address/address.postalCode|<axsl:text/><axsl:value-of select="hl7:addr/hl7:postalCode"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$addrCount=1">+++address/address.addressKey|<axsl:text/><axsl:value-of select="hl7:addr/hl7:addressKey"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$addrCount=1  and @use='TMP'">+++address/address.desc|<axsl:text/><axsl:value-of select="hl7:addr/hl7:desc"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$addrCount=1">+++address/address.addr.line1|<axsl:text/><axsl:value-of select="hl7:addr/hl7:streetAddressLine[1]"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$addrCount=1">+++address/address.addr.line2|<axsl:text/><axsl:value-of select="hl7:addr/hl7:streetAddressLine[2]"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$addrCount=1">+++address/address.addr.line3|<axsl:text/><axsl:value-of select="hl7:addr/hl7:streetAddressLine[3]"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$addrCount=1">+++address/address.addr.line4|<axsl:text/><axsl:value-of select="hl7:addr/hl7:streetAddressLine[4]"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$addrCount=1">+++address/address.addr.line5|<axsl:text/><axsl:value-of select="hl7:addr/hl7:streetAddressLine[5]"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$addrCount=1">+++address/address.effective.high|<axsl:text/><axsl:value-of select="hl7:addr/hl7:useablePeriod/hl7:high/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$addrCount=1">+++address/address.effective.low|<axsl:text/><axsl:value-of select="hl7:addr/hl7:useablePeriod/hl7:low/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:variable name="telecomCount" select="count(hl7:telecom)"/>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;0">+++telecom1/use|<axsl:text/><axsl:value-of select="hl7:telecom[1]/@use"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;0">+++telecom1/telecom.tel|<axsl:text/><axsl:value-of select="hl7:telecom[1]/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;0">+++telecom1/telecom.effective.high|<axsl:text/><axsl:value-of select="hl7:telecom[1]/hl7:useablePeriod/hl7:high/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;0">+++telecom1/telecom.effective.low|<axsl:text/><axsl:value-of select="hl7:telecom[1]/hl7:useablePeriod/hl7:low/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;1">+++telecom2/use|<axsl:text/><axsl:value-of select="hl7:telecom[2]/@use"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;1">+++telecom2/telecom.tel|<axsl:text/><axsl:value-of select="hl7:telecom[2]/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;1">+++telecom2/telecom.effective.high|<axsl:text/><axsl:value-of select="hl7:telecom[2]/hl7:useablePeriod/hl7:high/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;1">+++telecom2/telecom.effective.low|<axsl:text/><axsl:value-of select="hl7:telecom[2]/hl7:useablePeriod/hl7:low/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;2">+++telecom3/use|<axsl:text/><axsl:value-of select="hl7:telecom[3]/@use"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;2">+++telecom3/telecom.tel|<axsl:text/><axsl:value-of select="hl7:telecom[3]/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;2">+++telecom3/telecom.effective.high|<axsl:text/><axsl:value-of select="hl7:telecom[3]/hl7:useablePeriod/hl7:high/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;2">+++telecom3/telecom.effective.low|<axsl:text/><axsl:value-of select="hl7:telecom[3]/hl7:useablePeriod/hl7:low/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;3">+++telecom4/use|<axsl:text/><axsl:value-of select="hl7:telecom[4]/@use"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;3">+++telecom4/telecom.tel|<axsl:text/><axsl:value-of select="hl7:telecom[4]/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;3">+++telecom4/telecom.effective.high|<axsl:text/><axsl:value-of select="hl7:telecom[4]/hl7:useablePeriod/hl7:high/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;3">+++telecom4/telecom.effective.low|<axsl:text/><axsl:value-of select="hl7:telecom[4]/hl7:useablePeriod/hl7:low/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;4">+++telecom5/use|<axsl:text/><axsl:value-of select="hl7:telecom[5]/@use"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;4">+++telecom5/telecom.tel|<axsl:text/><axsl:value-of select="hl7:telecom[5]/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;4">+++telecom5/telecom.effective.high|<axsl:text/><axsl:value-of select="hl7:telecom[5]/hl7:useablePeriod/hl7:high/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$telecomCount&gt;4">+++telecom5/telecom.effective.low|<axsl:text/><axsl:value-of select="hl7:telecom[5]/hl7:useablePeriod/hl7:low/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:variable name="hasPlayerName" select="count(hl7:player/hl7:name)=1"/>

		<!--REPORT -->
<axsl:if test="$hasPlayerName">+++name/use|<axsl:text/><axsl:value-of select="hl7:player/hl7:name/@use"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPlayerName">+++name/name.prefix|<axsl:text/><axsl:value-of select="hl7:player/hl7:name/hl7:prefix"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPlayerName">+++name/name.suffix|<axsl:text/><axsl:value-of select="hl7:player/hl7:name/hl7:suffix"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPlayerName">+++name/name.givenName.name1|<axsl:text/><axsl:value-of select="hl7:player/hl7:name/hl7:given[1]"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPlayerName">+++name/name.givenName.name2|<axsl:text/><axsl:value-of select="hl7:player/hl7:name/hl7:given[2]"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPlayerName">+++name/name.givenName.name3|<axsl:text/><axsl:value-of select="hl7:player/hl7:name/hl7:given[3]"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPlayerName">+++name/name.givenName.name4|<axsl:text/><axsl:value-of select="hl7:player/hl7:name/hl7:given[4]"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPlayerName">+++name/name.givenName.name5|<axsl:text/><axsl:value-of select="hl7:player/hl7:name/hl7:given[5]"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPlayerName">+++name/name.familyName|<axsl:text/><axsl:value-of select="hl7:player/hl7:name/hl7:family"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPlayerName">+++name/name.effective.high|<axsl:text/><axsl:value-of select="hl7:player/hl7:name/hl7:validTime/hl7:high/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPlayerName">+++name/name.effective.low|<axsl:text/><axsl:value-of select="hl7:player/hl7:name/hl7:validTime/hl7:low/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:variable name="hasLanguageCommunication" select="count(hl7:player/hl7:languageCommunication)=1"/>

		<!--REPORT -->
<axsl:if test="$hasLanguageCommunication">+++languageCommunication/languageCode.code|<axsl:text/><axsl:value-of select="hl7:player/hl7:languageCommunication/hl7:languageCode/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasLanguageCommunication">+++languageCommunication/proficiencyLevelCode.code|<axsl:text/><axsl:value-of select="hl7:player/hl7:languageCommunication/hl7:proficiencyLevelCode/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasLanguageCommunication">+++languageCommunication/proficiencyLevelCode.codeSystem|<axsl:text/><axsl:value-of select="hl7:player/hl7:languageCommunication/hl7:proficiencyLevelCode/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasLanguageCommunication">+++languageCommunication/preferenceInd.value|<axsl:text/><axsl:value-of select="hl7:player/hl7:languageCommunication/hl7:preferenceInd/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:variable name="hasPreferredContacts" select="count(hl7:subjectOf1/hl7:preferredContactMethod)=1"/>

		<!--REPORT -->
<axsl:if test="$hasPreferredContacts">+++preferredContacts/code.code|<axsl:text/><axsl:value-of select="hl7:subjectOf1/hl7:preferredContactMethod/hl7:code/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPreferredContacts">+++preferredContacts/code.codeSystem|<axsl:text/><axsl:value-of select="hl7:subjectOf1/hl7:preferredContactMethod/hl7:code/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPreferredContacts">+++preferredContacts/value.code|<axsl:text/><axsl:value-of select="hl7:subjectOf1/hl7:preferredContactMethod/hl7:value/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPreferredContacts">+++preferredContacts/value.codeSystem|<axsl:text/><axsl:value-of select="hl7:subjectOf1/hl7:preferredContactMethod/hl7:value/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPreferredContacts">+++preferredContacts/contactTimes.code|<axsl:text/><axsl:value-of select="hl7:subjectOf1/hl7:preferredContactMethod/hl7:pertinentInformation/hl7:pertinentPreferredContactTimes/hl7:code/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPreferredContacts">+++preferredContacts/contactTimes.codeSystem|<axsl:text/><axsl:value-of select="hl7:subjectOf1/hl7:preferredContactMethod/hl7:pertinentInformation/hl7:pertinentPreferredContactTimes/hl7:code/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPreferredContacts">+++preferredContacts/contactTimes.value|<axsl:text/><axsl:value-of select="hl7:subjectOf1/hl7:preferredContactMethod/hl7:pertinentInformation/hl7:pertinentPreferredContactTimes/hl7:value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:variable name="hasPreferredWrittenCommunicationFormat" select="count(hl7:subjectOf2/hl7:preferredWrittenCommunicationFormat)=1"/>

		<!--REPORT -->
<axsl:if test="$hasPreferredWrittenCommunicationFormat">+++preferredWrittenCommunicationFormat/code.code|<axsl:text/><axsl:value-of select="hl7:subjectOf2/hl7:preferredWrittenCommunicationFormat/hl7:code/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPreferredWrittenCommunicationFormat">+++preferredWrittenCommunicationFormat/code.codeSystem|<axsl:text/><axsl:value-of select="hl7:subjectOf2/hl7:preferredWrittenCommunicationFormat/hl7:code/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPreferredWrittenCommunicationFormat">+++preferredWrittenCommunicationFormat/value.code|<axsl:text/><axsl:value-of select="hl7:subjectOf2/hl7:preferredWrittenCommunicationFormat/hl7:value/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasPreferredWrittenCommunicationFormat">+++preferredWrittenCommunicationFormat/value.codeSystem|<axsl:text/><axsl:value-of select="hl7:subjectOf2/hl7:preferredWrittenCommunicationFormat/hl7:value/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:variable name="hasCallCentreCallBackConsent" select="count(hl7:subjectOf3/hl7:callCentreCallBackConsent)=1"/>

		<!--REPORT -->
<axsl:if test="$hasCallCentreCallBackConsent">+++callcentreCallbackConsent/code.code|<axsl:text/><axsl:value-of select="hl7:subjectOf3/hl7:callCentreCallBackConsent/hl7:code/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasCallCentreCallBackConsent">+++callcentreCallbackConsent/code.codeSystem|<axsl:text/><axsl:value-of select="hl7:subjectOf3/hl7:callCentreCallBackConsent/hl7:code/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasCallCentreCallBackConsent">+++callcentreCallbackConsent/value.code|<axsl:text/><axsl:value-of select="hl7:subjectOf3/hl7:callCentreCallBackConsent/hl7:value/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hasCallCentreCallBackConsent">+++callcentreCallbackConsent/value.codeSystem|<axsl:text/><axsl:value-of select="hl7:subjectOf3/hl7:callCentreCallBackConsent/hl7:value/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN addressTriggeredOutput-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:addr" priority="1000" mode="M26">
...
<!--PATTERN telecomTriggeredOutput-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:telecom" priority="1000" mode="M27">
...
<!--PATTERN nameTriggeredOutput-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:name" priority="1000" mode="M28">
...
<!--PATTERN pcProvisionTriggeredOutput-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson/hl7:playedOtherProviderPatient/hl7:subjectOf[1]/hl7:patientCareProvision" priority="1000" mode="M29">
...
<axsl:if test="count(hl7:code/@codeSystem)=1">+++patientCareProvision.codeSystem|<axsl:text/><axsl:value-of select="hl7:code/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="count(hl7:responsibleParty/hl7:healthCareProvider)=1">+++patientCareProvision.hcpCode|<axsl:text/><axsl:value-of select="hl7:responsibleParty/hl7:healthCareProvider/hl7:id/@extension"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:responsibleParty/hl7:healthCareProvider)=1">+++patientCareProvision.hcpCodeSystem|<axsl:text/><axsl:value-of select="hl7:responsibleParty/hl7:healthCareProvider/hl7:id/@root"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:performer/hl7:assignedOrganization)=1">+++patientCareProvision.hcpCode|<axsl:text/><axsl:value-of select="hl7:performer/hl7:assignedOrganization/hl7:id/@extension"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:performer/hl7:assignedOrganization)=1">+++patientCareProvision.hcpCodeSystem|<axsl:text/><axsl:value-of select="hl7:performer/hl7:assignedOrganization/hl7:id/@root"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN sharedSecretTriggeredOutput-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf5[@typeCode='SBJ']/hl7:sharedSecret[1]" priority="1000" mode="M30">
...
<!--PATTERN genderCheckOutput-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:administrativeGenderCode[1]" priority="1000" mode="M31">
...
<!--PATTERN birthTimeCheckOutput-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:birthTime[1]" priority="1000" mode="M32">
...
<!--PATTERN birthOrderOutput-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:multipleBirthOrderNumber[1]" priority="1000" mode="M33">

		<!--REPORT -->
<axsl:if test="true()">***@updateMode|birthOrder/birthOrder.value|<axsl:text/><axsl:value-of select="@value"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M33"/></axsl:template><axsl:template match="text()" priority="-1" mode="M33"/><axsl:template match="@*|node()" priority="-2" mode="M33"><axsl:apply-templates select="@*|*" mode="M33"/></axsl:template>

<!--PATTERN deceasedTimeCheckOutput-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:deceasedTime[1]" priority="1000" mode="M34">
...
<!--PATTERN deathNotificationCheckOutput-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf7[1]/hl7:deathNotification[1]" priority="1000" mode="M35">
...
<!--PATTERN authorCheckOutput-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]" priority="1000" mode="M36"><axsl:variable name="authorPersonID" select="hl7:author/hl7:AgentPersonSDS/hl7:agentPersonSDS/hl7:id/@extension"/><axsl:variable name="authorSystemID" select="hl7:author1/hl7:AgentSystemSDS/hl7:agentSystemSDS/hl7:id/@extension"/><axsl:variable name="deathStatus" select="hl7:subject/hl7:PdsUpdateRequest/hl7:subject/hl7:patientRole/hl7:subjectOf7/hl7:deathNotification/hl7:value/@code"/><axsl:variable name="deceasedTime" select="hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:deceasedTime[1]/@value"/><axsl:variable name="overalUpdateMode" select="hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:deceasedTime[1]/@updateMode"/><axsl:variable name="hasRegisteringAuthority" select="count(hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1])&gt;0"/>
...
<axsl:if test="$hasRegisteringAuthority">+++regAuthorityType.codeSystem|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:code/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="count(hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:assignedRegisteringPerson)&gt;0">+++regPerson.root|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:assignedRegisteringPerson/hl7:id/@root"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:assignedRegisteringPerson)&gt;0">+++regPerson.extension|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:assignedRegisteringPerson/hl7:id/@extension"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:representedRegisteringOrganization)&gt;0">+++regOrganisation.root|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:representedRegisteringOrganization/hl7:id/@root"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:representedRegisteringOrganization)&gt;0">+++regOrganisation.extension|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:representedRegisteringOrganization/hl7:id/@extension"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:id)&gt;0">+++regOrganisation.root|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:id/@root"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:id)&gt;0">+++regOrganisation.extension|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:id/@extension"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN languageOutput-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:languageCommunication[1]" priority="1000" mode="M37">
...
<!--PATTERN preferredWrittenCommunicationFormatOutput-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf4[1]/hl7:preferredWrittenCommunicationFormat[1]" priority="1000" mode="M38">
...
<!--PATTERN healthspaceRegistrationOutput-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf3[1]/hl7:healthspaceRegistration[1]" priority="1000" mode="M39">
...
<!--PATTERN preferredContactMethodOutput-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf2[1]/hl7:preferredContactMethod[1]" priority="1000" mode="M40">
...
<!--PATTERN consentCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf1/hl7:consent" priority="1000" mode="M41">
...
<!--PATTERN birthplaceOutput-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:birthplace[1]" priority="1000" mode="M42">
...
<axsl:if test="true()">+++birthplace.county|<axsl:text/><axsl:value-of select="hl7:addr/hl7:county"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="true()">***END-BLOCK***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M42"/></axsl:template><axsl:template match="text()" priority="-1" mode="M42"/><axsl:template match="@*|node()" priority="-2" mode="M42"><axsl:apply-templates select="@*|*" mode="M42"/></axsl:template></axsl:stylesheet>
