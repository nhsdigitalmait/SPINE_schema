...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		<hl7:PORX_IN110101UK04 xmlns:hl7="urn:hl7-org:v3">
			<hl7:id>
			...
			<hl7:interactionId root="2.16.840.1.113883.2.1.3.2.4.12" extension="PORX_IN110101UK04"/>
				...
				<hl7:subject typeCode="SUBJ" contextConductionInd="false">
					<hl7:PrescriptionReleaseReject classCode="SBADM" moodCode="EVN" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ppdbatch="http://spine.nhs.uk/spine-service-ppd" xmlns:fn="http://www.w3.org/2005/02/xpath-functions" xmlns:eb="http://www.oasis-open.org/committees/ebxml-msg/schema/msg-header-2_0.xsd" xmlns:soapcsf="http://www.w3.org/2001/12/soap-envelope" xmlns="urn:hl7-org:v3" xmlns:nasp="http://spine.nhs.uk/spine-servicev1.0" xmlns:soap="http://www.w3.org/2001/12/soap-envelope">
						...
						<hl7:pertinentInformation typeCode="PERT">
							<hl7:pertinentRejectionReason classCode="OBS" moodCode="EVN">
								<hl7:code code="PRRR" codeSystem="2.16.840.1.113883.2.1.3.2.4.17.30"/>
						...
						<hl7:reversalOf typeCode="REV">
							<hl7:priorPrescriptionReleaseRequestRef type="ControlAct" classCode="INFO" moodCode="RQO">
								<hl7:id>
									<xsl:attribute name="root">
										<xsl:value-of select="$refToEventID" />
									</xsl:attribute>
								</hl7:id>
							</hl7:priorPrescriptionReleaseRequestRef>
						</hl7:reversalOf>
					</hl7:PrescriptionReleaseReject>
				</hl7:subject>
			</hl7:ControlActEvent>
		</hl7:PORX_IN110101UK04>
	</xsl:template>
</xsl:stylesheet>