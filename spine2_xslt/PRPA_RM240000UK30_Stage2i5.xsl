...
<axsl:choose><axsl:when test="count(hl7:id[@root='2.16.840.1.113883.2.1.3.2.4.18.1'])=1"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING_SUPP_INFO[scopedRelatedPersonRole.id]|scopedRelatedPersonRole.id***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M2"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject/hl7:patientRole/hl7:patientPerson/hl7:scopedRelatedPersonRole" priority="1000" mode="M2"><axsl:variable name="objectIDCount" select="count(hl7:id[@root='2.16.840.1.113883.2.1.3.2.4.18.1'])"/><axsl:variable name="nhsNumberIDCount" select="count(hl7:id[@root='2.16.840.1.113883.2.1.4.1']) + count(hl7:player/hl7:playedRelatedPatient/hl7:id)"/><axsl:variable name="subjectOf3Count" select="count(hl7:subjectOf3[1])"/><axsl:variable name="nextOfKinValue" select="*/hl7:partNextOfKin/hl7:code/@code"/><axsl:variable name="partCount" select="count(hl7:part[1])"/><axsl:variable name="part3Count" select="count(hl7:part3[1])"/><axsl:variable name="addrCount" select="count(hl7:addr[1])"/><axsl:variable name="telecomCount" select="count(hl7:telecom)"/><axsl:variable name="nameCount" select="count(hl7:player/hl7:name[1])"/><axsl:variable name="subjectOf1Count" select="count(hl7:subjectOf1[1])"/><axsl:variable name="subjectOf2Count" select="count(hl7:subjectOf2[1])"/><axsl:variable name="nhsNumberOnlyFields" select="$addrCount + $telecomCount +  $nameCount +  $subjectOf1Count + $subjectOf2Count"/>
...
<axsl:choose><axsl:when test="not($nhsNumberIDCount&gt;1)"/><axsl:otherwise>***fault|ErrorBase1742.RELATED_PERSON_INCORRRECT_ID_FIELDS[scopedRelatedPersonRole.relatedPatient.id]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--REPORT -->
<axsl:if test="$nextOfKinValue='2'">***warning|ErrorBase1742Extended.INVALID_RELATEDPERSON_NEXTOFKIN_SUPP_INFO|Value of 2 (No) is not supported for Next Of Kin***<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN addressCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:addr[@updateMode='removed']" priority="1001" mode="M3">
...
<axsl:choose><axsl:when test="string-length(hl7:id/@extension)&gt;0"/><axsl:otherwise>***fault|ErrorBase1742.UID_MUST_BE_PROVIDED***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M3"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:addr|/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject/hl7:patientRole/hl7:patientPerson/hl7:scopedRelatedPersonRole/hl7:addr" priority="1000" mode="M3">
...
<axsl:choose><axsl:when test="count(hl7:useablePeriod)=0 or count(hl7:useablePeriod)=1"/><axsl:otherwise>***fault|ErrorBase1742.MORE_THAN_ONE_USABLE_PERIOD***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:useablePeriod/hl7:low)=0 or count(hl7:useablePeriod/hl7:high)=0 or (not(hl7:useablePeriod/hl7:high/@value) or hl7:useablePeriod/hl7:high/@value &gt;= hl7:useablePeriod/hl7:low/@value)"/><axsl:otherwise>***fault|ErrorBase1742.HIGH_TIME_NOT_GREATER_THAN_LOW_TIME***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M3"/></axsl:template><axsl:template match="text()" priority="-1" mode="M3"/><axsl:template match="@*|node()" priority="-2" mode="M3"><axsl:apply-templates select="@*|*" mode="M3"/></axsl:template>

<!--PATTERN telecomCheck-->


	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:telecom[@updateMode='removed']" priority="1001" mode="M4">
...
<axsl:choose><axsl:when test="string-length(hl7:id/@extension)&gt;0"/><axsl:otherwise>***fault|ErrorBase1742.UID_MUST_BE_PROVIDED***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M4"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:telecom|/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject/hl7:patientRole/hl7:patientPerson/hl7:scopedRelatedPersonRole/hl7:telecom" priority="1000" mode="M4">
...
<!--PATTERN nameCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:name[@updateMode='removed']" priority="1001" mode="M5">
...
<axsl:choose><axsl:when test="string-length(hl7:id/@extension)&gt;0"/><axsl:otherwise>***fault|ErrorBase1742.UID_MUST_BE_PROVIDED***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M5"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:name|/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject/hl7:patientRole/hl7:patientPerson/hl7:scopedRelatedPersonRole/hl7:player/hl7:name" priority="1000" mode="M5">
...
<axsl:choose><axsl:when test="count(hl7:validTime)=0 or count(hl7:validTime)=1"/><axsl:otherwise>***fault|ErrorBase1742.MORE_THAN_ONE_USABLE_PERIOD***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:validTime/hl7:low)=0 or count(hl7:validTime/hl7:high)=0 or (not(hl7:validTime/hl7:high/@value) or hl7:validTime/hl7:high/@value &gt;= hl7:validTime/hl7:low/@value)"/><axsl:otherwise>***fault|ErrorBase1742.HIGH_TIME_NOT_GREATER_THAN_LOW_TIME***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M5"/></axsl:template><axsl:template match="text()" priority="-1" mode="M5"/><axsl:template match="@*|node()" priority="-2" mode="M5"><axsl:apply-templates select="@*|*" mode="M5"/></axsl:template>

<!--PATTERN pcProvisionCheck-->


	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson/hl7:playedOtherProviderPatient/hl7:subjectOf[1]/hl7:patientCareProvision[1][@updateMode='removed']" priority="1001" mode="M6">

		<!--ASSERT -->
<axsl:choose><axsl:when test="string-length(hl7:id/@extension)&gt;0"/><axsl:otherwise>***fault|ErrorBase1742.UID_MUST_BE_PROVIDED***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M6"/></axsl:template>

	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson/hl7:playedOtherProviderPatient/hl7:subjectOf[1]/hl7:patientCareProvision[1]" priority="1000" mode="M6"><axsl:variable name="mim63" select="count(/hl7:PRPA_IN000203UK03[1])"/><axsl:variable name="provisionType" select="hl7:code/@code"/>
...
<!--PATTERN sharedSecretCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf5/hl7:sharedSecret[1][not(@updateMode='removed')]" priority="1000" mode="M7">
...
<!--PATTERN genderCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:administrativeGenderCode[1][@updateMode='removed']" priority="1000" mode="M8">
...
<!--PATTERN birthTimeCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:birthTime[1][@updateMode='removed']" priority="1000" mode="M9">
...
<!--PATTERN birthOrderCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:multipleBirthOrderNumber[1]" priority="1000" mode="M10">
...
<!--PATTERN interactionSpecificChecks-->
	...
	<!--RULE -->
<axsl:template match="hl7:PRPA_IN100000UK14" priority="1000" mode="M12"><axsl:variable name="updateModedeceasedTime" select="hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:deceasedTime[1]/@updateMode"/><axsl:variable name="updateModedeathNotification" select="hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf7[1]/hl7:deathNotification[1]/@updateMode"/>
...
<!--PATTERN deceasedTimeCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:deceasedTime[1]" priority="1000" mode="M15">
...
<!--PATTERN deathNotificationCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf7[1]/hl7:deathNotification[1]" priority="1000" mode="M16">
...
<!--PATTERN registeringAuthorityCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]" priority="1000" mode="M17"><axsl:variable name="mim63" select="count(/hl7:PRPA_IN000203UK03[1])=1"/><axsl:variable name="preMim63" select="not($mim63)"/>
...
<!--PATTERN healthspaceRegistrationCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf3[1]/hl7:healthspaceRegistration[1]" priority="1000" mode="M20">
...
<!--PATTERN preferredContactMethodCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf2[1]/hl7:preferredContactMethod[1]|/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject/hl7:patientRole/hl7:patientPerson/hl7:scopedRelatedPersonRole/hl7:subjectOf1[1]/hl7:preferredContactMethod" priority="1000" mode="M21">
...
<!--PATTERN consentCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf1/hl7:consent" priority="1000" mode="M22"><axsl:variable name="mim63" select="count(/hl7:PRPA_IN000203UK03[1])"/>
...
<axsl:if test="(count(hl7:pertinentInformation)&gt;0) and (hl7:code/@code='6' or $mim63=1)">***fault|ErrorBase1742.INVALID_DATA_FOR_CALL_CENTRE_CALL_BACK***<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="not(@updateMode='removed') and count(hl7:pertinentInformation/hl7:pertinentSupplementaryComments)&gt;0 and string-length(hl7:pertinentInformation/hl7:pertinentSupplementaryComments/hl7:value)=0">***warning|ErrorBase1742.SUPPLEMENTARY_COMMENTS_VALUE_MISSING***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M22"/></axsl:template><axsl:template match="text()" priority="-1" mode="M22"/><axsl:template match="@*|node()" priority="-2" mode="M22"><axsl:apply-templates select="@*|*" mode="M22"/></axsl:template>

<!--PATTERN birthplaceCheck-->


	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:birthplace[1]" priority="1000" mode="M23"><axsl:variable name="cityCount" select="count(hl7:addr/hl7:city)"/><axsl:variable name="countyCount" select="count(hl7:addr/hl7:county)"/><axsl:variable name="countryCount" select="count(hl7:addr/hl7:country)"/><axsl:variable name="updateMode" select="hl7:addr/@updateMode"/>
...
<!--PATTERN scopedRelatedPersonOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject/hl7:patientRole/hl7:patientPerson/hl7:scopedRelatedPersonRole" priority="1000" mode="M24"><axsl:variable name="mim63" select="count(/hl7:PRPA_IN000203UK03[1])"/>
...
<axsl:if test="true()">+++correspondence.codeSystem|<axsl:text/><axsl:value-of select="hl7:part1/hl7:partCorrespondence/hl7:code/@codeSystem|hl7:part/hl7:partCorrespondence/hl7:code/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="(*/hl7:partNextOfKin/hl7:code/@code='1')">+++nextOfKin.code|1|hl7:part3/hl7:partNextOfKin/hl7:code/@code"/&gt;+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++nextOfKin.codeSystem|<axsl:text/><axsl:value-of select="*/hl7:partNextOfKin/hl7:code/@codeSystem|hl7:part3/hl7:partNextOfKin/hl7:code/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:variable name="addrCount" select="count(hl7:addr)=1"/>
...
<axsl:if test="$addrCount=1">+++address/address.addressKey|<axsl:text/><axsl:value-of select="hl7:addr/hl7:addressKey"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="$addrCount=1">+++address/address.desc|<axsl:text/><axsl:value-of select="hl7:addr/hl7:desc"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN addressTriggeredOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:addr" priority="1000" mode="M25">
...
<!--PATTERN telecomTriggeredOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:telecom" priority="1000" mode="M26">
...
<!--PATTERN nameTriggeredOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:name" priority="1000" mode="M27">
...
<!--PATTERN pcProvisionTriggeredOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson/hl7:playedOtherProviderPatient/hl7:subjectOf[1]/hl7:patientCareProvision" priority="1000" mode="M28">
...
<!--PATTERN sharedSecretTriggeredOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf5[@typeCode='SBJ']/hl7:sharedSecret[1]" priority="1000" mode="M29">
...
<!--PATTERN genderCheckOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:administrativeGenderCode[1]" priority="1000" mode="M30">
...
<!--PATTERN birthTimeCheckOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:birthTime[1]" priority="1000" mode="M31">
...
<!--PATTERN birthOrderOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:multipleBirthOrderNumber[1]" priority="1000" mode="M32">
...
<!--PATTERN deceasedTimeCheckOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:deceasedTime[1]" priority="1000" mode="M33">
...
<!--PATTERN deathNotificationCheckOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf7[1]/hl7:deathNotification[1]" priority="1000" mode="M34">
...
<!--PATTERN languageOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:languageCommunication[1]" priority="1000" mode="M36">
...
<!--PATTERN preferredWrittenCommunicationFormatOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf4[1]/hl7:preferredWrittenCommunicationFormat[1]" priority="1000" mode="M37">
...
<!--PATTERN healthspaceRegistrationOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf3[1]/hl7:healthspaceRegistration[1]" priority="1000" mode="M38">
...
<!--PATTERN preferredContactMethodOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf2[1]/hl7:preferredContactMethod[1]" priority="1000" mode="M39">
...
<!--PATTERN consentCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:subjectOf1/hl7:consent" priority="1000" mode="M40">
...
<!--PATTERN birthplaceOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:subject[1]/hl7:patientRole[1]/hl7:patientPerson[1]/hl7:birthplace[1]" priority="1000" mode="M41">
...
<axsl:if test="true()">+++birthplace.county|<axsl:text/><axsl:value-of select="hl7:addr/hl7:county"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="true()">***END-BLOCK***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M41"/></axsl:template><axsl:template match="text()" priority="-1" mode="M41"/><axsl:template match="@*|node()" priority="-2" mode="M41"><axsl:apply-templates select="@*|*" mode="M41"/></axsl:template></axsl:stylesheet>
