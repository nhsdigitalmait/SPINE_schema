...
<!--SCHEMA METADATA-->
<axsl:template match="/"><axsl:apply-templates select="/" mode="M3"/><axsl:apply-templates select="/" mode="M4"/><axsl:apply-templates select="/" mode="M5"/><axsl:apply-templates select="/" mode="M6"/><axsl:apply-templates select="/" mode="M7"/></axsl:template>
...
<!--PATTERN correctPatternRoots-->
	...
	<!--RULE -->
<axsl:template match="/hl7:PORX_IN100101UK04/hl7:ControlActEvent/hl7:subject/hl7:DispenseProposalReturn" priority="1000" mode="M4">

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:component/hl7:prescriptionRef)=1"/><axsl:otherwise>***fault|ErrorBase1634.UNABLE_TO_PROCESS|hl7:pertinentPrescriptionID not found***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:pertinentInformation/hl7:pertinentReturnReason)=1"/><axsl:otherwise>***fault|ErrorBase1634.UNABLE_TO_PROCESS|hl7:pertinentReturnReason not found***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<!--PATTERN prescriptionIDCheck-->
	...
	<!--RULE -->
<axsl:template match="/hl7:PORX_IN100101UK04/hl7:ControlActEvent/hl7:subject/hl7:DispenseProposalReturn/hl7:component/hl7:prescriptionRef" priority="1000" mode="M6">
