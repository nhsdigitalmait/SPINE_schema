...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:param name="responseAction">REPC_IN020000SM13</xsl:param>
    ...
    <xsl:param name="lrRecordId"></xsl:param>
    <xsl:param name="ptvRecordId"></xsl:param>
    <xsl:param name="wsaRequestGUID">example-request-GUID</xsl:param>

    <xsl:template match="/">

        <SOAP:Envelope xmlns:crs="http://national.carerecords.nhs.uk/schema/crs/" xmlns:SOAP="http://schemas.xmlsoap.org/soap/envelope/"
            xmlns:wsa="http://schemas.xmlsoap.org/ws/2004/08/addressing" xmlns="urn:hl7-org:v3" xmlns:hl7="urn:hl7-org:v3">
            <SOAP:Header>
                ...
                <communicationFunctionRcv typeCode="RCV">
                    <device classCode="DEV" determinerCode="INSTANCE">
                        <id root="1.2.826.0.1285.0.2.0.107"><xsl:attribute name="extension"><xsl:value-of select="$toASID" /></xsl:attribute>
                        </id>
                    </device>
            ...
            <SOAP:Body>
                <hl7:REPC_IN020000SM13 xmlns:hl7="urn:hl7-org:v3">
                    <hl7:id>
                    ...
                    <hl7:interactionId root="2.16.840.1.113883.2.1.3.2.4.12" extension="REPC_IN020000SM13" />
                    ...
                    <hl7:ControlActEvent classCode="CACT" moodCode="EVN">
                        ...
                        <hl7:subject typeCode="SUBJ" contextConductionInd="false">
                            <xsl:if test='$lrRecordId!=""'>
                                <hl7:CreationResponseConfirm classCode="PCPR" moodCode="EVN">
                                    <hl7:id root="2.16.840.1.113883.2.1.3.2.4.18.3">
                                        <xsl:attribute name="extension">
                                <xsl:value-of select="$lrRecordId" />
                            </xsl:attribute>
                                    </hl7:id>
                                </hl7:CreationResponseConfirm>
                            </xsl:if>
                            <xsl:if test='$ptvRecordId!=""'>
                                <hl7:CreationPermissionToViewResponseConfirm classCode="PCPR" moodCode="EVN">
                                    <hl7:id>
                                        <xsl:attribute name="extension">
                                <xsl:value-of select="$ptvRecordId" />
                            </xsl:attribute>
                                    </hl7:id>
                                </hl7:CreationPermissionToViewResponseConfirm>
                            </xsl:if>
                        </hl7:subject>
                    </hl7:ControlActEvent>
                </hl7:REPC_IN020000SM13>
            </SOAP:Body>
        </SOAP:Envelope>
