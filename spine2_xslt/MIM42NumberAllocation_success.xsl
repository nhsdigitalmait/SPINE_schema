...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
<hl7:PRPA_IN060000UK30 xmlns:hl7="urn:hl7-org:v3">
	...
	<hl7:interactionId root="2.16.840.1.113883.2.1.3.2.4.12" extension="PRPA_IN060000UK30"/>
	...
	<hl7:ControlActEvent classCode="CACT" moodCode="EVN">
		...
		<hl7:reason typeCode="RSON">
			<hl7:justifyingDetectedIssueEvent classCode="ALRT" moodCode="EVN">
				<hl7:code codeSystem="2.16.840.1.113883.2.1.3.2.4.17.42"><xsl:attribute name="code"><xsl:value-of select="$warningCode1"/></xsl:attribute><xsl:attribute name="displayName"><xsl:value-of select="$warningDesc1"/></xsl:attribute>
					<hl7:qualifier>
