...
<axsl:template match="SOAP:Envelope/SOAP:Header" priority="1000" mode="M3">
		...
		<!--REPORT -->
<axsl:if test="true()">***report|extractedActionName|urn:nhs:names:services:cpisquery/ACCESS_TO_SERVICE***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|interactionID|ACCESS_TO_SERVICE***<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN QueryParametersReport-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope/SOAP:Body/hl7:ACCESS_TO_SERVICE" priority="1000" mode="M4">
