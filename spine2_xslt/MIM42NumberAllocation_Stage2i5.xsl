...
<axsl:choose><axsl:when test="string-length($provisionType)&gt;0"/><axsl:otherwise>***fault|ErrorBase1742.UNSUPPORTED_PATIENT_CARE***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="$hcpCodeCheck"/><axsl:otherwise>***fault|ErrorBase1742.UNSUPPORTED_HCP_CODE_TYPE***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<!--PATTERN registeringAuthorityCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]" priority="1000" mode="M9">

		<!--REPORT -->
<axsl:if test="hl7:code/@code='y' and count(hl7:assignedRegisteringPerson)=0">***fault|ErrorBase1742.ASSIGNED_REG_PERSON_MISSING***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="not(hl7:code/@code='y') and count(hl7:assignedRegisteringPerson)&gt;0">***warning|ErrorBase1742.INVALID_ASSIGNED_REGISTERING_PERSON***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:representedRegisteringOrganization)&gt;0"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING_SUPP_INFO[registeringAuthority.representedRegisteringOrganization]|registeringAuthority.representedRegisteringOrganization***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M9"/></axsl:template><axsl:template match="text()" priority="-1" mode="M9"/><axsl:template match="@*|node()" priority="-2" mode="M9"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M9"/></axsl:template>
...
<axsl:if test="$hasRegisteringAuthority">+++regAuthorityType.codeSystem|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:code/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:code/@code='y' and count(hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:assignedRegisteringPerson)&gt;0">+++regPerson.root|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:assignedRegisteringPerson/hl7:id/@root"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:code/@code='y' and count(hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:assignedRegisteringPerson)&gt;0">+++regPerson.extension|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:assignedRegisteringPerson/hl7:id/@extension"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:representedRegisteringOrganization)&gt;0">+++regOrganisation.root|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:representedRegisteringOrganization/hl7:id/@root"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:representedRegisteringOrganization)&gt;0">+++regOrganisation.extension|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:representedRegisteringOrganization/hl7:id/@extension"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:id)&gt;0">+++regOrganisation.root|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:id/@root"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:id)&gt;0">+++regOrganisation.extension|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsRegistrationRequest[1]/hl7:author[1]/hl7:registeringAuthority[1]/hl7:id/@extension"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
