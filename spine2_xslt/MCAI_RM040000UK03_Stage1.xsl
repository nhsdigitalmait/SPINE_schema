...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:sch="http://www.ascc.net/xml/schematron" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:hl7="urn:hl7-org:v3" xmlns:SOAP="http://schemas.xmlsoap.org/soap/envelope/" version="1.0"><!--Implementers: please note that overriding process-prolog or process-root is 
...
<!--PATTERN correctRoot-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:PRPA_IN000203SM03/hl7:ControlActEvent/hl7:subject" priority="1000" mode="M2">
...
<!--PATTERN basicLayout-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:PRPA_IN000203SM03/hl7:ControlActEvent/hl7:subject/hl7:PdsUpdateRequest" priority="1000" mode="M3">

		<!--ASSERT -->
<axsl:choose><axsl:when test="hl7:code[@codeSystem='2.16.840.1.113883.2.1.3.2.4.17.40']/@code='1' or hl7:code[@codeSystem='2.16.840.1.113883.2.1.3.2.4.17.40']/@code='2'"/><axsl:otherwise>***fault|ErrorBase1742.INVALID_UPDATE_MODE***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="count(hl7:pertinentInformation/hl7:pertinentSerialChangeNumber/hl7:code[@code='2'][@codeSystem='2.16.840.1.113883.2.1.3.2.4.17.35'])=1"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="string-length(hl7:pertinentInformation[@typeCode='PERT']/hl7:pertinentSerialChangeNumber/hl7:value/@value)&gt;0"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<!--PATTERN nhsNumberCheck-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/hl7:PRPA_IN000203SM03/hl7:ControlActEvent/hl7:subject/hl7:PdsUpdateRequest/hl7:subject/hl7:patientRole" priority="1000" mode="M4">

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:id[@root='2.16.840.1.113883.2.1.4.1'])=1"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="string-length(hl7:id[@root='2.16.840.1.113883.2.1.4.1']/@extension)=10"/><axsl:otherwise>***fault|ErrorBase1742.FAILED_MOD11_CHECK***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
