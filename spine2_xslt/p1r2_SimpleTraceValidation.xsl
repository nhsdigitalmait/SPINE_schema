...
<axsl:if test="true()">***report|messageID|<axsl:text/><axsl:value-of select="hl7:id/@root"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="true()">***report|toSystemID|<axsl:text/><axsl:value-of select="hl7:communicationFunctionRcv/hl7:device/hl7:id[@root='1.2.826.0.1285.0.2.0.107']/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|fromSystemID|<axsl:text/><axsl:value-of select="hl7:communicationFunctionSnd/hl7:device/hl7:id[@root='1.2.826.0.1285.0.2.0.107']/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M8"/></axsl:template><axsl:template match="text()" priority="-1" mode="M8"/><axsl:template match="@*|node()" priority="-2" mode="M8"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M8"/></axsl:template>
...
<axsl:template match="SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent" priority="1000" mode="M14">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:query/hl7:person.birthTime/hl7:value/@value)=1"/><axsl:otherwise>***fault|ErrorBase1742.MISSING_MANDATORY_SEARCH_FIELD[birthTime]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:query/hl7:person.name/hl7:value/hl7:family)=1"/><axsl:otherwise>***fault|ErrorBase1742.MISSING_MANDATORY_SEARCH_FIELD[name.family]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:variable name="gender" select="hl7:query/hl7:person.administrativeGenderCode/hl7:value/@code"/>

		<!--ASSERT -->
<axsl:choose><axsl:when test="$gender='0' or $gender='1' or $gender='2' or $gender='9'"/><axsl:otherwise>***fault|ErrorBase1742.MISSING_MANDATORY_SEARCH_FIELD[administrativeGenderCode]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M14"/></axsl:template><axsl:template match="text()" priority="-1" mode="M14"/><axsl:template match="@*|node()" priority="-2" mode="M14"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M14"/></axsl:template>

<!--PATTERN simpleTraceReport-->


	<!--RULE -->
<axsl:template match="SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent/hl7:query" priority="1000" mode="M15">

		<!--REPORT -->
<axsl:if test="false()">***BEGIN-LIST-ENTRY|report|simpleTraceRequests***<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<axsl:if test="false()"><axsl:text/><axsl:value-of select="concat('***report|', 'interaction|', ancestor::node()[2]/@interaction, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="true()"><axsl:text/><axsl:value-of select="concat('***report|', 'administrativeGenderCode|', hl7:person.administrativeGenderCode/hl7:value/@code, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()"><axsl:text/><axsl:value-of select="concat('***report|', 'birthTime|', hl7:person.birthTime/hl7:value/@value, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:variable name="nameElement" select="hl7:person.name/hl7:value"/>

		<!--REPORT -->
<axsl:if test="true()"><axsl:text/><axsl:value-of select="concat('***report|', 'name.family|', $nameElement/hl7:family, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()"><axsl:text/><axsl:value-of select="concat('***report|', 'givenNameCount|', count($nameElement/hl7:given), '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$nameElement/hl7:given[1]"><axsl:text/><axsl:value-of select="concat('***report|', 'name.given|', $nameElement/hl7:given[1], '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$nameElement/hl7:given[2]"><axsl:text/><axsl:value-of select="concat('***report|', 'name.otherGiven1|', $nameElement/hl7:given[2], '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$nameElement/hl7:given[3]"><axsl:text/><axsl:value-of select="concat('***report|', 'name.otherGiven2|', $nameElement/hl7:given[3], '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$nameElement/hl7:given[4]"><axsl:text/><axsl:value-of select="concat('***report|', 'name.otherGiven3|', $nameElement/hl7:given[4], '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$nameElement/hl7:given[5]"><axsl:text/><axsl:value-of select="concat('***report|', 'name.otherGiven4|', $nameElement/hl7:given[5], '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:person.deceasedTime"><axsl:text/><axsl:value-of select="concat('***report|', 'deceasedTime|', hl7:person.deceasedTime/hl7:value/@value, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:person.address/hl7:value/hl7:postalCode"><axsl:text/><axsl:value-of select="concat('***report|', 'address.postalCode|', hl7:person.address/hl7:value/hl7:postalCode, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:person.address/hl7:value/hl7:addressKey"><axsl:text/><axsl:value-of select="concat('***report|', 'address.addressKey|', hl7:person.address/hl7:value/hl7:addressKey, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>
