...
<!--SCHEMA METADATA-->
<axsl:template match="/"><axsl:apply-templates select="/" mode="M3"/><axsl:apply-templates select="/" mode="M4"/><axsl:apply-templates select="/" mode="M5"/><axsl:apply-templates select="/" mode="M6"/><axsl:apply-templates select="/" mode="M7"/><axsl:apply-templates select="/" mode="M8"/><axsl:apply-templates select="/" mode="M9"/></axsl:template>
...
<!--PATTERN correctRoot-->
	...
	<!--RULE -->
<axsl:template match="/hl7:PORX_IN999000UK01/hl7:ControlActEvent/hl7:subject" priority="1000" mode="M3">
...
<!--PATTERN correctPatternRoots-->
	...
	<!--RULE -->
<axsl:template match="/hl7:PORX_IN999000UK01/hl7:ControlActEvent/hl7:subject/hl7:prescriptionUpdateRequest" priority="1000" mode="M4">
...
<!--PATTERN agentOrganisationCheck-->
	...
	<!--RULE -->
<axsl:template match="//hl7:author/hl7:AgentPerson/hl7:representedOrganization" priority="1000" mode="M6">
...
<!--PATTERN prescriptionReference-->
	...
	<!--RULE -->
<axsl:template match="/hl7:PORX_IN999000UK01/hl7:ControlActEvent/hl7:subject/hl7:prescriptionUpdateRequest/hl7:reference" priority="1000" mode="M7">
...
<!--PATTERN optionalItems-->
	...
	<!--RULE -->
<axsl:template match="/hl7:PORX_IN999000UK01/hl7:ControlActEvent/hl7:subject/hl7:prescriptionUpdateRequest/hl7:optionalItems" priority="1000" mode="M8">
...
<axsl:if test="count(hl7:nominatedPerformer)=1">***report|nominatedPerformer|<axsl:text/><axsl:value-of select="hl7:nominatedPerformer/@value"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="count(hl7:nominatedPerformerType)=1">***report|nominatedPerformerType|<axsl:text/><axsl:value-of select="hl7:nominatedPerformerType/@value"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN lineItemUpdates-->
	...
	<!--RULE -->
<axsl:template match="/hl7:PORX_IN999000UK01/hl7:ControlActEvent/hl7:subject/hl7:prescriptionUpdateRequest/hl7:optionalItems" priority="1000" mode="M9">
