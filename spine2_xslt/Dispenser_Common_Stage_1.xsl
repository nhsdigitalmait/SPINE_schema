...
<!--PATTERN authorRootCheck-->


	<!--RULE -->
<axsl:template match="//hl7:author[not(hl7:AgentPersonSDS)]" priority="1000" mode="M3">

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:AgentPerson)=1"/><axsl:otherwise>***fault|ErrorBase1634.UNABLE_TO_PROCESS|AgentPerson Element missing or blank***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:AgentPerson/hl7:representedOrganization)=1"/><axsl:otherwise>***fault|ErrorBase1634.UNABLE_TO_PROCESS|representedOrganization Element missing or blank***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*" mode="M3"/></axsl:template><axsl:template match="text()" priority="-1" mode="M3"/><axsl:template match="@*|node()" priority="-2" mode="M3"><axsl:apply-templates select="*" mode="M3"/></axsl:template>

<!--PATTERN legalAuthenticatorRootCheck-->


	<!--RULE -->
<axsl:template match="//hl7:legalAuthenticator" priority="1000" mode="M4">
...
<!--PATTERN dispenserInformationCheck-->


	<!--RULE -->
<axsl:template match="//hl7:AgentPerson" priority="1000" mode="M5">
...
<axsl:if test="count(hl7:code[@codeSystem='1.2.826.0.1285.0.2.1.104']/@code)=1">***report|agentSdsRole|<axsl:text/><axsl:value-of select="hl7:code[@codeSystem='1.2.826.0.1285.0.2.1.104']/@code"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:telecom/@value)=1 or count(*/hl7:telecom/@value)=1"/><axsl:otherwise>***warning|ErrorBase1634.UNABLE_TO_PROCESS|Agent telecom value missing or blank***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="count(hl7:Person/hl7:name)=1 or count(hl7:agentPerson/hl7:name)=1"/><axsl:otherwise>***fault|ErrorBase1634.UNABLE_TO_PROCESS|Agent name is missing***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:agentPerson/hl7:id/@extension)=1"/><axsl:otherwise>***fault|ErrorBase1634.UNABLE_TO_PROCESS|Dispenser ID missing or blank***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--REPORT -->
<axsl:if test="count(hl7:agentPerson/hl7:id/@extension)=1">***report|dispenserCode|<axsl:text/><axsl:value-of select="hl7:agentPerson/hl7:id/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*" mode="M5"/></axsl:template><axsl:template match="text()" priority="-1" mode="M5"/><axsl:template match="@*|node()" priority="-2" mode="M5"><axsl:apply-templates select="*" mode="M5"/></axsl:template>

<!--PATTERN dispensingOrganisationCheck-->


	<!--RULE -->
<axsl:template match="//hl7:AgentPerson/hl7:representedOrganization" priority="1000" mode="M6">
...
<axsl:choose><axsl:when test="count(hl7:telecom/@value)=1"/><axsl:otherwise>***fault|ErrorBase1634.UNABLE_TO_PROCESS|representedOrganization telecom is missing or blank***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:addr)=1"/><axsl:otherwise>***fault|ErrorBase1634.UNABLE_TO_PROCESS|representedOrganization address is missing***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*" mode="M6"/></axsl:template><axsl:template match="text()" priority="-1" mode="M6"/><axsl:template match="@*|node()" priority="-2" mode="M6"><axsl:apply-templates select="*" mode="M6"/></axsl:template></axsl:stylesheet>
