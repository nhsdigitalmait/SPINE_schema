...
<!--PATTERN correctRoot-->
	...
	<!--RULE -->
<axsl:template match="/hl7:PORX_IN100101UK31/hl7:ControlActEvent/hl7:subject" priority="1000" mode="M3">

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:DispenseProposalReturn)=1"/><axsl:otherwise>***fault|ErrorBase1634.UNABLE_TO_PROCESS|hl7:DispenseProposalReturn root not found***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M3"/></axsl:template><axsl:template match="text()" priority="-1" mode="M3"/><axsl:template match="@*|node()" priority="-2" mode="M3"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M3"/></axsl:template>

<!--PATTERN correctPatternRoots-->


	<!--RULE -->
<axsl:template match="/hl7:PORX_IN100101UK31/hl7:ControlActEvent/hl7:subject/hl7:DispenseProposalReturn" priority="1000" mode="M4">

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:pertinentInformation1/hl7:pertinentPrescriptionID)=1"/><axsl:otherwise>***fault|ErrorBase1634.UNABLE_TO_PROCESS|hl7:pertinentPrescriptionID not found***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:pertinentInformation3/hl7:pertinentReturnReason)=1"/><axsl:otherwise>***fault|ErrorBase1634.UNABLE_TO_PROCESS|hl7:pertinentReturnReason not found***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:author/hl7:AgentPerson/hl7:agentPerson)=1"/><axsl:otherwise>***fault|ErrorBase1634.UNABLE_TO_PROCESS|hl7:AgentPerson/hl7:agentPerson not found***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:author/hl7:AgentPerson/hl7:representedOrganization)=1"/><axsl:otherwise>***fault|ErrorBase1634.UNABLE_TO_PROCESS|hl7:representedOrganization not found***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/></axsl:template><axsl:template match="text()" priority="-1" mode="M4"/><axsl:template match="@*|node()" priority="-2" mode="M4"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/></axsl:template>
...
<!--PATTERN prescriptionIDCheck-->
	...
	<!--RULE -->
<axsl:template match="/hl7:PORX_IN100101UK31/hl7:ControlActEvent/hl7:subject/hl7:DispenseProposalReturn/hl7:pertinentInformation1/hl7:pertinentPrescriptionID" priority="1000" mode="M6">
...
<!--PATTERN returnReasonCheck-->


	<!--RULE -->
<axsl:template match="/hl7:PORX_IN100101UK31/hl7:ControlActEvent/hl7:subject/hl7:DispenseProposalReturn/hl7:pertinentInformation3/hl7:pertinentReturnReason" priority="1000" mode="M7">

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:value)=1"/><axsl:otherwise>***fault|ErrorBase1634.UNABLE_TO_PROCESS|A single return reason must be provided***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--REPORT -->
<axsl:if test="count(hl7:value)=1">***report|returnReasonCode|<axsl:text/><axsl:value-of select="hl7:value/@code"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:value)=1">***report|returnReasonText|<axsl:text/><axsl:value-of select="hl7:value/@displayName"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M7"/></axsl:template><axsl:template match="text()" priority="-1" mode="M7"/><axsl:template match="@*|node()" priority="-2" mode="M7"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M7"/></axsl:template>

<!--PATTERN currentInstanceText-->


	<!--RULE -->
<axsl:template match="/hl7:PORX_IN100101UK31/hl7:ControlActEvent/hl7:subject/hl7:DispenseProposalReturn" priority="1000" mode="M8">

		<!--REPORT -->
<axsl:if test="count(hl7:pertinentInformation2/hl7:pertinentRepeatInstanceInfo)=1">***report|currentInstance|<axsl:text/><axsl:value-of select="hl7:pertinentInformation2/hl7:pertinentRepeatInstanceInfo/hl7:value/@value"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:pertinentInformation2/hl7:pertinentRepeatInstanceInfo)=0">***report|currentInstance|1***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M8"/></axsl:template><axsl:template match="text()" priority="-1" mode="M8"/><axsl:template match="@*|node()" priority="-2" mode="M8"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M8"/></axsl:template></axsl:stylesheet>
