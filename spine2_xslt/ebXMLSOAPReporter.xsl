...
<!--SCHEMA METADATA-->
<axsl:template match="/"><axsl:apply-templates select="/" mode="M6"/><axsl:apply-templates select="/" mode="M7"/></axsl:template>
...
<axsl:template match="SOAP:Envelope[1]/SOAP:Header[1]" priority="1000" mode="M6">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="eb:MessageHeader/@eb:version = '2.0'"/><axsl:otherwise>***fault|ErrorBase1732.INVALID_ID326***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
