...
<!--PATTERN RetrievalQueryChecks-->


	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:query[1]" priority="1000" mode="M14"><axsl:variable name="hdIndicator" select="hl7:historicDataIndicator/hl7:value/@code"/><axsl:variable name="nhsNumberElement" select="hl7:person.id/hl7:value"/>

		<!--ASSERT -->
<axsl:choose><axsl:when test="$hdIndicator='1' or $hdIndicator='0'"/><axsl:otherwise>***fault|ErrorBase1742.INVALID_HISTORIC_DATA_INDICATOR***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="$nhsNumberElement/@root='2.16.840.1.113883.2.1.4.1'"/><axsl:otherwise>***warning|ErrorBase1742.NHS_NUMBER_UNSPECIFIED***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count($nhsNumberElement/@extension)=1"/><axsl:otherwise>***fault|ErrorBase1742.NHS_NUMBER_UNSPECIFIED***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="string-length($nhsNumberElement/@extension)=10"/><axsl:otherwise>***fault|ErrorBase1742.INVALID_NHS_NUMBER***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M14"/></axsl:template><axsl:template match="text()" priority="-1" mode="M14"/><axsl:template match="@*|node()" priority="-2" mode="M14"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M14"/></axsl:template>

<!--PATTERN ReportRQDetails-->


	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:query[1]" priority="1000" mode="M15"><axsl:variable name="nhsNumberElement" select="hl7:person.id/hl7:value"/><axsl:variable name="hdIndicatorElement" select="hl7:historicDataIndicator/hl7:value"/>

		<!--REPORT -->
<axsl:if test="false()">***BEGIN-LIST-ENTRY|report|retrieveRequests***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="false()"><axsl:text/><axsl:value-of select="concat('***report|', 'messageId|', ancestor::node()[2]/@messageId, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="false()"><axsl:text/><axsl:value-of select="concat('***report|', 'interaction|', ancestor::node()[2]/@interaction, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count($nhsNumberElement)=1"><axsl:text/><axsl:value-of select="concat('***report|', 'nhsNumber|', $nhsNumberElement/@extension, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="$hdIndicatorElement"><axsl:text/><axsl:value-of select="concat('***report|', 'hdIndicator|', $hdIndicatorElement/@code, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:retrievalItem[1]"><axsl:text/><axsl:value-of select="concat('***report|', 'retrievalItem1|', hl7:retrievalItem[1]/hl7:semanticsText, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:retrievalItem[2]"><axsl:text/><axsl:value-of select="concat('***report|', 'retrievalItem2|', hl7:retrievalItem[2]/hl7:semanticsText, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:retrievalItem[3]"><axsl:text/><axsl:value-of select="concat('***report|', 'retrievalItem3|', hl7:retrievalItem[3]/hl7:semanticsText, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:retrievalItem[4]"><axsl:text/><axsl:value-of select="concat('***report|', 'retrievalItem4|', hl7:retrievalItem[4]/hl7:semanticsText, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:retrievalItem[5]"><axsl:text/><axsl:value-of select="concat('***report|', 'retrievalItem5|', hl7:retrievalItem[5]/hl7:semanticsText, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:retrievalItem[6]"><axsl:text/><axsl:value-of select="concat('***report|', 'retrievalItem6|', hl7:retrievalItem[6]/hl7:semanticsText, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:retrievalItem[7]"><axsl:text/><axsl:value-of select="concat('***report|', 'retrievalItem7|', hl7:retrievalItem[7]/hl7:semanticsText, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:retrievalItem[8]"><axsl:text/><axsl:value-of select="concat('***report|', 'retrievalItem8|', hl7:retrievalItem[8]/hl7:semanticsText, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:retrievalItem[9]"><axsl:text/><axsl:value-of select="concat('***report|', 'retrievalItem9|', hl7:retrievalItem[9]/hl7:semanticsText, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:retrievalItem[10]"><axsl:text/><axsl:value-of select="concat('***report|', 'retrievalItem10|', hl7:retrievalItem[10]/hl7:semanticsText, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:retrievalItem[11]"><axsl:text/><axsl:value-of select="concat('***report|', 'retrievalItem11|', hl7:retrievalItem[11]/hl7:semanticsText, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:retrievalItem[12]"><axsl:text/><axsl:value-of select="concat('***report|', 'retrievalItem12|', hl7:retrievalItem[12]/hl7:semanticsText, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:retrievalItem[13]"><axsl:text/><axsl:value-of select="concat('***report|', 'retrievalItem13|', hl7:retrievalItem[13]/hl7:semanticsText, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="hl7:retrievalItem[14]"><axsl:text/><axsl:value-of select="concat('***report|', 'retrievalItem14|', hl7:retrievalItem[14]/hl7:semanticsText, '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:retrievalItem)=0"><axsl:text/><axsl:value-of select="concat('***report|', 'retrievalItem1|person.scn', '***')"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="false()">***END-LIST-ENTRY***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M15"/></axsl:template><axsl:template match="text()" priority="-1" mode="M15"/><axsl:template match="@*|node()" priority="-2" mode="M15"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M15"/></axsl:template></axsl:stylesheet>
