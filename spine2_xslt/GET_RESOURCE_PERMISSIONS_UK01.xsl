...
<axsl:choose><axsl:when test="count(hl7:ControlActEvent[1]/hl7:author1)=1 or count(hl7:ControlActEvent[1]/hl7:author1)=2"/><axsl:otherwise>***fault|ErrorBase1732.CONTROL_ACT_AUTHOR_INVALID_CARDINALITY***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:ControlActEvent[1]/crs:getResourcePermissionsRequest)=1 and count(hl7:ControlActEvent[1]/crs:getResourcePermissionsRequest/*)&gt;0"/><axsl:otherwise>***fault|ErrorBase1732.CONTROL_ACT_QUERY_INVALID***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<axsl:template match="SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent" priority="1000" mode="M15">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(crs:getResourcePermissionsRequest/crs:accessControlQuery/crs:resourceContext)=1"/><axsl:otherwise>***fault|ErrorBase1712.MANDATORY_DATA_MISSING|accessControlQuery.resourceContext***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--REPORT -->
<axsl:if test="count(crs:getResourcePermissionsRequest/crs:accessControlQuery/crs:queryCriteria)&gt;1">***fault|ErrorBase1712.INVALID_ACA_CARDINALITY***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*" mode="M15"/></axsl:template><axsl:template match="text()" priority="-1" mode="M15"/><axsl:template match="@*|node()" priority="-2" mode="M15"><axsl:apply-templates select="*" mode="M15"/></axsl:template>

<!--PATTERN resourceContext-->


	<!--RULE -->
<axsl:template match="SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent/crs:getResourcePermissionsRequest/crs:accessControlQuery" priority="1000" mode="M16">
...
<!--PATTERN NHSNumberConsistencyCheck-->
	...
	<!--RULE -->
<axsl:template match="//crs:queryCriteria[not(crs:function/crs:context='Sealing')]" priority="1000" mode="M17">
...
<!--PATTERN queryCriteria-->


	<!--RULE -->
<axsl:template match="//crs:queryCriteria/crs:resource" priority="1000" mode="M18">
...
<axsl:choose><axsl:when test="count(../crs:function/crs:context)=1"/><axsl:otherwise>***fault|ErrorBase1712.FUNCTION_CONTEXT_EMPTY***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(crs:type)=1"/><axsl:otherwise>***fault|ErrorBase1712.RESOURCE_TYPE_EMPTY***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(crs:Id)=1"/><axsl:otherwise>***fault|ErrorBase1712.RESOURCE_ID_EMPTY***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--REPORT -->
<axsl:if test="true()">***report|function.context|<axsl:text/><axsl:value-of select="../crs:function/crs:context"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***report|function.code|<axsl:text/><axsl:value-of select="../crs:function/crs:code"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">***BEGIN-LIST-ENTRY|report|resourceSet***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++resource.type|<axsl:text/><axsl:value-of select="crs:type"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++resource.id|<axsl:text/><axsl:value-of select="crs:Id"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
