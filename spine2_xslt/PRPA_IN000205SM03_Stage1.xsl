...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:sch="http://www.ascc.net/xml/schematron" xmlns:iso="http://purl.oclc.org/dsdl/schematron" xmlns:SOAP="http://schemas.xmlsoap.org/soap/envelope/" xmlns:nasp="http://spine.nhs.uk/spine-servicev1.0" xmlns:wsa="http://schemas.xmlsoap.org/ws/2004/08/addressing" xmlns:hl7="urn:hl7-org:v3" version="1.0"><!--Implementers: please note that overriding process-prolog or process-root is 
...
<!--SCHEMA METADATA-->
<axsl:template match="/"><axsl:apply-templates select="/" mode="M4"/><axsl:apply-templates select="/" mode="M5"/></axsl:template>

<!--SCHEMATRON PATTERNS-->


<!--PATTERN HL7TransmissionWrapperCheckAndReport-->


	<!--RULE -->
<axsl:template match="/" priority="1001" mode="M4">

		<!--REPORT -->
<axsl:if test="count(/SOAP:Envelope/SOAP:Body/*)=0">***fault|ErrorBase1732.HL7_VALIDATION_ERROR|no transmission wrapper***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(/SOAP:Envelope/SOAP:Body/*)&gt;1">***fault|ErrorBase1732.HL7_VALIDATION_ERROR|multiple transmission wrappers***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/></axsl:template>

	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*" priority="1000" mode="M4"><axsl:variable name="interactionIdNode" select="hl7:interactionId[@root='2.16.840.1.113883.2.1.3.2.4.12']/@extension"/><axsl:variable name="toAsidNode" select="hl7:communicationFunctionRcv/hl7:device/hl7:id[@root='1.2.826.0.1285.0.2.0.107']/@extension"/><axsl:variable name="fromAsidNode" select="hl7:communicationFunctionSnd/hl7:device/hl7:id[@root='1.2.826.0.1285.0.2.0.107']/@extension"/>
...
<axsl:choose><axsl:when test="count(hl7:versionCode)=1 and string-length(hl7:versionCode/@code)&gt;0"/><axsl:otherwise>***fault|ErrorBase1732.INVALID_VERSION_CODE***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count($interactionIdNode)=1 and $interactionIdNode=local-name()"/><axsl:otherwise>***fault|ErrorBase1732.INCONSISTENT_HL7_INTERACTION_ID***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count($toAsidNode)=1 and string-length($toAsidNode) &gt; 0"/><axsl:otherwise>***fault|ErrorBase1732.INVALID_COMM_FUNC_RCV***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count($fromAsidNode)=1 and string-length($fromAsidNode) &gt; 0"/><axsl:otherwise>***fault|ErrorBase1732.INVALID_COMM_FUNC_SND***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<axsl:if test="true()">***report|creationTime|<axsl:text/><axsl:value-of select="hl7:creationTime/@value"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="true()">***report|interactionID|<axsl:text/><axsl:value-of select="$interactionIdNode"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if>
