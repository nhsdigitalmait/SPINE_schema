...
<!--PATTERN correctRoot-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]" priority="1000" mode="M2">
...
<!--PATTERN extractJSON-->
	...
	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]" priority="1000" mode="M3">

		<!--REPORT -->
<axsl:if test="true()">+++report|updatedRecord|<axsl:text/><axsl:value-of select="hl7:subject"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M3"/></axsl:template><axsl:template match="text()" priority="-1" mode="M3"/><axsl:template match="@*|node()" priority="-2" mode="M3"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M3"/></axsl:template>

<!--PATTERN extractSCN-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:pertinentInformation/hl7:pertinentSerialChangeNumber" priority="1000" mode="M4">

		<!--REPORT -->
<axsl:if test="true()">+++report|serialChangeNumber|<axsl:text/><axsl:value-of select="hl7:value/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/></axsl:template><axsl:template match="text()" priority="-1" mode="M4"/><axsl:template match="@*|node()" priority="-2" mode="M4"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M4"/></axsl:template>

<!--PATTERN ignoreDuplicatesOutput-->


	<!--RULE -->
<axsl:template match="/SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest[1]/hl7:pertinentInformation/hl7:pertinentIgnoreDuplicateRecordCriterion" priority="1000" mode="M5">
