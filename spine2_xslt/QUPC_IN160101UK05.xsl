...
<!--PATTERN checkFilterParameters-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:query[1]/hl7:filterParameters" priority="1000" mode="M11"><axsl:variable name="hasSetId" select="count(hl7:setID)=1"/><axsl:variable name="hasDocumentType" select="count(hl7:documentType)=1"/><axsl:variable name="hasDate" select="count(hl7:date)=1"/><axsl:variable name="hasSetIdAndNotDocTypeOrDate" select="$hasSetId and not($hasDocumentType or $hasDate)"/><axsl:variable name="hasDocTypeOrDateAndNotSetId" select="($hasDocumentType or $hasDate) and not($hasSetId)"/>

		<!--ASSERT -->
<axsl:choose><axsl:when test="$hasSetIdAndNotDocTypeOrDate or $hasDocTypeOrDateAndNotSetId"/><axsl:otherwise>***fault|ErrorBase1733.SET_ID_NOT_ALLOWED_WITH_OTHER_PARAMS[checkFilterParameters.invalidCombination]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M11"/></axsl:template><axsl:template match="text()" priority="-1" mode="M11"/><axsl:template match="@*|node()" priority="-2" mode="M11"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M11"/></axsl:template>

<!--PATTERN checkQuerySetID-->


	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:query[1]/hl7:filterParameters/hl7:setID" priority="1000" mode="M12">
...
<!--PATTERN checkQueryDocumentType-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:query[1]/hl7:filterParameters/hl7:documentType" priority="1000" mode="M13">
...
<!--PATTERN checkQueryDocumentDate-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:query[1]/hl7:filterParameters/hl7:date" priority="1000" mode="M14">

		<!--ASSERT -->
<axsl:choose><axsl:when test="string-length(hl7:value/@low)&gt;0"/><axsl:otherwise>***fault|ErrorBase1733.MANDATORY_FILTER_PARAMETER_MISSING[checkQueryDocumentDate.missingLow]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="string-length(hl7:value/@high)&gt;0"/><axsl:otherwise>***fault|ErrorBase1733.MANDATORY_FILTER_PARAMETER_MISSING[checkQueryDocumentDate.missingHigh]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M14"/></axsl:template><axsl:template match="text()" priority="-1" mode="M14"/><axsl:template match="@*|node()" priority="-2" mode="M14"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M14"/></axsl:template>

<!--PATTERN reportHeader-->


	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Header[1]" priority="1000" mode="M15">
...
<!--PATTERN reportBody-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]" priority="1000" mode="M16">
...
<!--PATTERN reportAuthorPerson-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:author" priority="1000" mode="M17">
...
<!--PATTERN reportAuthorSystem1-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:author1[1]/hl7:AgentSystemSDS/hl7:agentSystemSDS" priority="1000" mode="M18">
...
<!--PATTERN reportAuthorSystem2-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:author1[2]/hl7:AgentSystemSDS/hl7:agentSystemSDS" priority="1000" mode="M19">
...
<!--PATTERN reportQuery-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:query[1]" priority="1000" mode="M20">
...
<!--PATTERN reportFilterParameters-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:query[1]/hl7:filterParameters" priority="1000" mode="M21">
