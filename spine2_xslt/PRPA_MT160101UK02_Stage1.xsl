...
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsUpdateRequest" priority="1000" mode="M2">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="hl7:code[@code='1']/@code='1' or hl7:code[@code='2']/@code='2'"/><axsl:otherwise>***fault|ErrorBase1742.INVALID_UPDATE_MODE***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="count(hl7:subject/hl7:patientRole)=1"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:pertinentInformation/hl7:pertinentSerialChangeNumber/hl7:code[@code='2'])=1"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
