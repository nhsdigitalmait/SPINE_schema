...
<!--PATTERN BodyChecks-->
	...
	<!--RULE -->
<axsl:template match="hl7:QUPA_IN000006SM02" priority="1000" mode="M7">
...
<axsl:choose><axsl:when test="count(hl7:ControlActEvent[1]/hl7:author1)=1 or count(hl7:ControlActEvent[1]/hl7:author1)=2"/><axsl:otherwise>***fault|ErrorBase1732.CONTROL_ACT_AUTHOR_INVALID_CARDINALITY***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:ControlActEvent[1]/hl7:query)=1"/><axsl:otherwise>***fault|ErrorBase1732.CONTROL_ACT_QUERY_INVALID***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<!--PATTERN AuthorCheck-Person-->
	...
	<!--RULE -->
<axsl:template match="hl7:QUPA_IN000006SM02/hl7:ControlActEvent[1]/hl7:author" priority="1000" mode="M8">
...
<!--PATTERN AuthorCheck-System1-->
	...
	<!--RULE -->
<axsl:template match="hl7:QUPA_IN000006SM02/hl7:ControlActEvent[1]/hl7:author1[1]" priority="1000" mode="M9">
