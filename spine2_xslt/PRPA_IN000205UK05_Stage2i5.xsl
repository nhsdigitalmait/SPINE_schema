...
<axsl:template match="*" priority="1000" mode="M2">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent)=1"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[rootLevelCheck:PdsRegistrationEvent]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M2"/></axsl:template><axsl:template match="text()" priority="-1" mode="M2"/><axsl:template match="@*|node()" priority="-2" mode="M2"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M2"/></axsl:template>

<!--PATTERN registrationEventCheck-->


	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]" priority="1000" mode="M3">
...
<!--PATTERN registeringAuthorityCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:author[1]/hl7:registeringAuthority" priority="1000" mode="M4">
...
<!--PATTERN ignoreDuplicateRecordCriterionCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:pertinentInformation[1]/hl7:pertinentIgnoreDuplicateRecordCriterion" priority="1000" mode="M5">
...
<!--PATTERN patientCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]" priority="1000" mode="M6">
...
<axsl:choose><axsl:when test="count(hl7:patientPerson) = 1"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[patientCheck:patientPerson]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:patientPerson/hl7:name[@use='L']/hl7:family) = 1"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[patientPersonCheck:name]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="not(count(hl7:subjectOf4/hl7:deathNotification) &gt; 1)"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[patientCheck:deathNotification]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:subjectOf4/hl7:deathNotification/hl7:responsibleParty/hl7:registeringAuthority/hl7:code/@code) = count(hl7:subjectOf4/hl7:deathNotification)"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[patientCheck:deathNotification:registeringAuthority:code]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:subjectOf4/hl7:deathNotification/hl7:responsibleParty/hl7:registeringAuthority/hl7:id/@extension) = count(hl7:subjectOf4/hl7:deathNotification)"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[patientCheck:deathNotification:registeringAuthority:id]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M6"/></axsl:template><axsl:template match="text()" priority="-1" mode="M6"/><axsl:template match="@*|node()" priority="-2" mode="M6"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M6"/></axsl:template>

<!--PATTERN patientPersonCheck-->


	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:patientPerson" priority="1000" mode="M7"><axsl:variable name="birthTimeLength" select="string-length(hl7:COCT_MT000210UK01.PartBirthTime/hl7:partPerson/hl7:birthTime/@value)"/>

		<!--ASSERT -->
<axsl:choose><axsl:when test="string-length(hl7:COCT_MT000209UK01.PartAdminGenderCode/hl7:partPerson/hl7:administrativeGenderCode/@code) &gt; 0"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[patientPersonCheck:administrativeGenderCode]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="$birthTimeLength = 0 or $birthTimeLength &gt;= 12"/><axsl:otherwise>***fault|ErrorBase1742.INSERT_BIRTH_MANDATORY_DATA_MISSING[BirthTime size incorrect]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="not(count(hl7:COCT_MT000211UK01.PartDeceasedTime/hl7:partPerson/hl7:deceasedTime/@value) &gt; 1)"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[patientPersonCheck:deceasedTime]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="string-length(hl7:multipleBirthOrderNumber/@value) &gt; 0"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[patientPersonCheck:multipleBirthOrderNumber]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="not(count(hl7:name) &gt; 1)"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[patientPersonCheck:name]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M7"/></axsl:template><axsl:template match="text()" priority="-1" mode="M7"/><axsl:template match="@*|node()" priority="-2" mode="M7"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M7"/></axsl:template>

<!--PATTERN deathNotificationCheck-->


	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:subjectOf4[1]/hl7:deathNotification" priority="1000" mode="M8">
...
<!--PATTERN deathNotificationCrossCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]" priority="1000" mode="M9"><axsl:variable name="deceasedTime" select="count(hl7:patientPerson/hl7:COCT_MT000211UK01.PartDeceasedTime/hl7:partPerson/hl7:deceasedTime/@value)"/><axsl:variable name="deathNotification" select="count(hl7:subjectOf4[1]/hl7:deathNotification)"/>
...
<!--PATTERN birthWeightCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:subjectOf1[1]/hl7:birthWeight" priority="1000" mode="M10">
...
<!--PATTERN clinicalInformationCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:subjectOf2[1]/hl7:clinicalInformation" priority="1000" mode="M11">
...
<!--PATTERN suspectedCongenitalAbnormalityCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:subjectOf2[1]/hl7:clinicalInformation/hl7:component1/hl7:suspectedCongenitalAbnormality" priority="1000" mode="M12">
...
<!--PATTERN stillbirthIndicatorCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:subjectOf2[1]/hl7:clinicalInformation/hl7:component2/hl7:stillbirthIndicator" priority="1000" mode="M13">
...
<!--PATTERN numberOfFoetusInConfinementCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:subjectOf2[1]/hl7:clinicalInformation/hl7:component3/hl7:numberOfFoetusInConfinement" priority="1000" mode="M14">
...
<!--PATTERN gestationAgeCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:subjectOf2[1]/hl7:clinicalInformation/hl7:component4/hl7:gestationAge" priority="1000" mode="M15">
...
<!--PATTERN obstetricCareProvisionCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:babyOf/hl7:obstetricCareProvision" priority="1000" mode="M16">
...
<!--PATTERN deliveryLocationCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:babyOf/hl7:obstetricCareProvision/hl7:location/hl7:participantDeliveryLocation" priority="1000" mode="M17">
...
<axsl:choose><axsl:when test="not(count(hl7:locatedPlaceOfBirth/hl7:name) &gt; 1)"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[deliveryLocationCheck:placeOfBirth:name]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:locatedPlaceOfBirth) = 0 or count(hl7:locatedPlaceOfBirth/hl7:name) = 1"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[deliveryLocationCheck:placeOfBirth:name]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M17"/></axsl:template><axsl:template match="text()" priority="-1" mode="M17"/><axsl:template match="@*|node()" priority="-2" mode="M17"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M17"/></axsl:template>

<!--PATTERN identifiedDeliveryLocationCheck-->


	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:babyOf/hl7:obstetricCareProvision/hl7:location/hl7:participantIdentifiedDeliveryLocation" priority="1000" mode="M18">
...
<axsl:choose><axsl:when test="count(hl7:locatedPlaceOfBirth) = 1"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[identifiedDeliveryLocationCheck:locatedPlaceOfBirth]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="not(count(hl7:locatedPlaceOfBirth/hl7:addr) &gt; 1)"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[identifiedDeliveryLocationCheck:placeOfBirth:addr]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<!--PATTERN notifierPersonCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:babyOf/hl7:obstetricCareProvision/hl7:author/hl7:notifier/hl7:assignedNotifierPerson" priority="1000" mode="M19">
...
<!--PATTERN motherCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:babyOf/hl7:obstetricCareProvision/hl7:recordTarget/hl7:mother" priority="1000" mode="M20">

		<!--ASSERT -->
<axsl:choose><axsl:when test="string-length(hl7:id[@root='2.16.840.1.113883.2.1.4.1']/@extension) &gt; 0"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[motherCheck:id]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<!--PATTERN motherPersonCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:babyOf/hl7:obstetricCareProvision/hl7:recordTarget/hl7:mother/hl7:patientMotherPerson" priority="1000" mode="M21">

		<!--ASSERT -->
<axsl:choose><axsl:when test="string-length(hl7:birthTime/@value) &gt; 0"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[motherPersonCheck:birthTime]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
...
<!--PATTERN primaryCareProvisionCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:babyOf/hl7:obstetricCareProvision/hl7:recordTarget/hl7:mother/hl7:subjectOf/hl7:primaryCareProvision" priority="1000" mode="M22">
...
<axsl:choose><axsl:when test="not(count(hl7:effectiveTime) &gt; 1)"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[primaryCareProvisionCheck:effectiveTime]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="string-length(hl7:performer/hl7:assignedOrganization/hl7:id[@root='2.16.840.1.113883.2.1.4.3']/@extension)"/><axsl:otherwise>***fault|ErrorBase1742.MANDATORY_FIELD_MISSING[primaryCareProvisionCheck:primaryCareProvider]***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M22"/></axsl:template><axsl:template match="text()" priority="-1" mode="M22"/><axsl:template match="@*|node()" priority="-2" mode="M22"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M22"/></axsl:template>

<!--PATTERN registeringAuthorityOutput-->


	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]" priority="1000" mode="M23">
...
<axsl:if test="true()">+++deathStatus|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:subjectOf4[1]/hl7:deathNotification[1]/hl7:value[1]/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="count(hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:patientPerson[1]/hl7:COCT_MT000211UK01.PartDeceasedTime/hl7:partPerson/hl7:deceasedTime/@value)=1">+++deceasedTime|<axsl:text/><axsl:value-of select="hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:patientPerson[1]/hl7:COCT_MT000211UK01.PartDeceasedTime/hl7:partPerson/hl7:deceasedTime/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN addressOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:addr" priority="1000" mode="M24">
...
<!--PATTERN telecomOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:telecom" priority="1000" mode="M25">
...
<!--PATTERN nameOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:patientPerson[1]/hl7:name" priority="1000" mode="M26">
...
<!--PATTERN genderOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:patientPerson[1]" priority="1000" mode="M27">

		<!--REPORT -->
<axsl:if test="count(hl7:COCT_MT000209UK01.PartAdminGenderCode/hl7:partPerson/hl7:administrativeGenderCode/@code)=1">***BEGIN-BLOCK|added|gender***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:COCT_MT000209UK01.PartAdminGenderCode/hl7:partPerson/hl7:administrativeGenderCode/@code)=1">+++gender.code|<axsl:text/><axsl:value-of select="hl7:COCT_MT000209UK01.PartAdminGenderCode/hl7:partPerson/hl7:administrativeGenderCode/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:COCT_MT000209UK01.PartAdminGenderCode/hl7:partPerson/hl7:administrativeGenderCode/@code)=1">+++gender.notificationTime|<axsl:text/><axsl:value-of select="hl7:COCT_MT000209UK01.PartAdminGenderCode/hl7:subjectOf/hl7:notificationTime/hl7:value/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:COCT_MT000209UK01.PartAdminGenderCode/hl7:partPerson/hl7:administrativeGenderCode/@code)=1">***END-BLOCK***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M27"/></axsl:template><axsl:template match="text()" priority="-1" mode="M27"/><axsl:template match="@*|node()" priority="-2" mode="M27"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M27"/></axsl:template>

<!--PATTERN birthTimeOutput-->


	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:patientPerson[1]" priority="1000" mode="M28">

		<!--REPORT -->
<axsl:if test="count(hl7:COCT_MT000210UK01.PartBirthTime/hl7:partPerson/hl7:birthTime/@value)=1">***BEGIN-BLOCK|added|birthTime***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:COCT_MT000210UK01.PartBirthTime/hl7:partPerson/hl7:birthTime/@value)=1">+++birthTime.value|<axsl:text/><axsl:value-of select="hl7:COCT_MT000210UK01.PartBirthTime/hl7:partPerson/hl7:birthTime/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:COCT_MT000210UK01.PartBirthTime/hl7:partPerson/hl7:birthTime/@value)=1">+++birthTime.notificationTime|<axsl:text/><axsl:value-of select="hl7:COCT_MT000210UK01.PartBirthTime/hl7:subjectOf/hl7:notificationTime/hl7:value/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:COCT_MT000210UK01.PartBirthTime/hl7:partPerson/hl7:birthTime/@value)=1">***END-BLOCK***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M28"/></axsl:template><axsl:template match="text()" priority="-1" mode="M28"/><axsl:template match="@*|node()" priority="-2" mode="M28"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M28"/></axsl:template>

<!--PATTERN deceasedTimeOutput-->


	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:patientPerson[1]" priority="1000" mode="M29">

		<!--REPORT -->
<axsl:if test="count(hl7:COCT_MT000211UK01.PartDeceasedTime/hl7:partPerson/hl7:deceasedTime/@value)=1">***BEGIN-BLOCK|added|deceasedTime***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:COCT_MT000211UK01.PartDeceasedTime/hl7:partPerson/hl7:deceasedTime/@value)=1">+++deceasedTime.value|<axsl:text/><axsl:value-of select="hl7:COCT_MT000211UK01.PartDeceasedTime/hl7:partPerson/hl7:deceasedTime/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:COCT_MT000211UK01.PartDeceasedTime/hl7:partPerson/hl7:deceasedTime/@value)=1">+++deceasedTime.notificationTime|<axsl:text/><axsl:value-of select="hl7:COCT_MT000211UK01.PartDeceasedTime/hl7:subjectOf/hl7:notificationTime/hl7:value/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="count(hl7:COCT_MT000211UK01.PartDeceasedTime/hl7:partPerson/hl7:deceasedTime/@value)=1">***END-BLOCK***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M29"/></axsl:template><axsl:template match="text()" priority="-1" mode="M29"/><axsl:template match="@*|node()" priority="-2" mode="M29"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M29"/></axsl:template>

<!--PATTERN deathNotificationOutput-->


	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:subjectOf4/hl7:deathNotification" priority="1000" mode="M30">
...
<axsl:if test="true()">+++deathNotification.value.codeSystem|2.16.840.1.113883.2.1.3.2.4.16.5+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="true()">+++deathNotification.registeringAuthority.code.code|<axsl:text/><axsl:value-of select="hl7:responsibleParty/hl7:registeringAuthority/hl7:code/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++deathNotification.registeringAuthority.code.codeSystem|2.16.840.1.113883.2.1.3.2.4.16.20+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++deathNotification.registeringAuthority.id.code|<axsl:text/><axsl:value-of select="hl7:responsibleParty/hl7:registeringAuthority/hl7:id/@extension"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++deathNotification.registeringAuthority.id.codeSystem|2.16.840.1.113883.2.1.4.3+++<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN birthOrderOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:patientPerson[1]/hl7:multipleBirthOrderNumber" priority="1000" mode="M31">
...
<!--PATTERN previousNhsContactOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]" priority="1000" mode="M32">
...
<!--PATTERN ethnicGroupOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]/hl7:patientPerson[1]/hl7:ethnicGroupCode" priority="1000" mode="M33">
...
<!--PATTERN birthInformationOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]" priority="1000" mode="M34">
...
<axsl:if test="$locationName">+++placeOfBirth.name|<axsl:text/><axsl:value-of select="$locationName"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="true()">+++placeOfBirth.addr.country.code|<axsl:text/><axsl:value-of select="hl7:patientPerson/hl7:COCT_MT000208UK01.BirthPlace/hl7:addr/hl7:country/hl7:code/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++placeOfBirth.addr.country.codeSystem|<axsl:text/><axsl:value-of select="hl7:patientPerson/hl7:COCT_MT000208UK01.BirthPlace/hl7:addr/hl7:country/hl7:code/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++placeOfBirth.addr.country.displayName|<axsl:text/><axsl:value-of select="hl7:patientPerson/hl7:COCT_MT000208UK01.BirthPlace/hl7:addr/hl7:country/hl7:code/@displayName"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++placeOfBirth.addr.county|<axsl:text/><axsl:value-of select="hl7:patientPerson/hl7:COCT_MT000208UK01.BirthPlace/hl7:addr/hl7:county"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++placeOfBirth.addr.city|<axsl:text/><axsl:value-of select="hl7:patientPerson/hl7:COCT_MT000208UK01.BirthPlace/hl7:addr/hl7:city"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++placeOfBirth.notificationTime|<axsl:text/><axsl:value-of select="hl7:patientPerson/hl7:COCT_MT000208UK01.BirthPlace/hl7:subjectOf/hl7:notificationTime/hl7:value/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<axsl:if test="true()">+++partnerChildHealth.id.extension|<axsl:text/><axsl:value-of select="hl7:babyOf[1]/hl7:obstetricCareProvision[1]/hl7:primaryInformationRecipient/hl7:partnerChildHealth[1]/hl7:id/@extension"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="true()">+++mother.nhsNumber.root|<axsl:text/><axsl:value-of select="hl7:babyOf[1]/hl7:obstetricCareProvision[1]/hl7:recordTarget[1]/hl7:mother[1]/hl7:id/@root"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++mother.nhsNumber.extension|<axsl:text/><axsl:value-of select="hl7:babyOf[1]/hl7:obstetricCareProvision[1]/hl7:recordTarget[1]/hl7:mother[1]/hl7:id/@extension"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++mother.birthTime|<axsl:text/><axsl:value-of select="substring(hl7:babyOf[1]/hl7:obstetricCareProvision[1]/hl7:recordTarget[1]/hl7:mother[1]/hl7:patientMotherPerson[1]/hl7:birthTime/@value,1,8)"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++mother.familyName|<axsl:text/><axsl:value-of select="hl7:babyOf[1]/hl7:obstetricCareProvision[1]/hl7:recordTarget[1]/hl7:mother[1]/hl7:patientMotherPerson[1]/hl7:name[1]/hl7:family"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++mother.givenName1|<axsl:text/><axsl:value-of select="hl7:babyOf[1]/hl7:obstetricCareProvision[1]/hl7:recordTarget[1]/hl7:mother[1]/hl7:patientMotherPerson[1]/hl7:name[1]/hl7:given[1]"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++mother.givenName2|<axsl:text/><axsl:value-of select="hl7:babyOf[1]/hl7:obstetricCareProvision[1]/hl7:recordTarget[1]/hl7:mother[1]/hl7:patientMotherPerson[1]/hl7:name[1]/hl7:given[2]"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<axsl:if test="true()">+++primaryCareProvision.effectiveTime.high|<axsl:text/><axsl:value-of select="hl7:babyOf[1]/hl7:obstetricCareProvision[1]/hl7:recordTarget[1]/hl7:mother[1]/hl7:subjectOf[1]/hl7:primaryCareProvision[1]/hl7:effectiveTime[1]/hl7:high/@value"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="true()">+++primaryCareProvision.performer.root|<axsl:text/><axsl:value-of select="hl7:babyOf[1]/hl7:obstetricCareProvision[1]/hl7:recordTarget[1]/hl7:mother[1]/hl7:subjectOf[1]/hl7:primaryCareProvision[1]/hl7:performer[1]/hl7:assignedOrganization[1]/hl7:id/@root"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++primaryCareProvision.performer.extension|<axsl:text/><axsl:value-of select="hl7:babyOf[1]/hl7:obstetricCareProvision[1]/hl7:recordTarget[1]/hl7:mother[1]/hl7:subjectOf[1]/hl7:primaryCareProvision[1]/hl7:performer[1]/hl7:assignedOrganization[1]/hl7:id/@extension"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN birthPlaceOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:subject[1]/hl7:patient[1]" priority="1000" mode="M35">

		<!--REPORT -->
<axsl:if test="true()">***BEGIN-BLOCK|added|birthplace***<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++birthplace.city|<axsl:text/><axsl:value-of select="hl7:patientPerson/hl7:COCT_MT000208UK01.BirthPlace/hl7:addr/hl7:city"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++birthplace.country.codeSystem|<axsl:text/><axsl:value-of select="hl7:patientPerson/hl7:COCT_MT000208UK01.BirthPlace/hl7:addr/hl7:country/hl7:code/@codeSystem"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++birthplace.country.code|<axsl:text/><axsl:value-of select="hl7:patientPerson/hl7:COCT_MT000208UK01.BirthPlace/hl7:addr/hl7:country/hl7:code/@code"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>

		<!--REPORT -->
<axsl:if test="true()">+++birthplace.county|<axsl:text/><axsl:value-of select="hl7:patientPerson/hl7:COCT_MT000208UK01.BirthPlace/hl7:addr/hl7:county"/><axsl:text/>+++<axsl:value-of select="string('&#10;')"/></axsl:if>
...
<!--PATTERN ignoreDuplicateRecordCriterionOutput-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsRegistrationEvent[1]/hl7:pertinentInformation[1]/hl7:pertinentIgnoreDuplicateRecordCriterion" priority="1000" mode="M36">

		<!--REPORT -->
<axsl:if test="true()">***report|ignoreDuplicateRecordCriterion|<axsl:text/><axsl:value-of select="hl7:value/@value"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M36"/></axsl:template><axsl:template match="text()" priority="-1" mode="M36"/><axsl:template match="@*|node()" priority="-2" mode="M36"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M36"/></axsl:template></axsl:stylesheet>
