...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	xmlns="urn:hl7-org:v3" xmlns:hl7="urn:hl7-org:v3" version="1.0">
	<xsl:output indent="yes" />
	<xsl:param name="cancellationResponseText">
		Text not provided
	</xsl:param>
	<xsl:param name="cancellationResponseCode">
		Code not provided
	</xsl:param>
	<xsl:param name="cancellationResponseCodeSystem">
		2.16.840.1.113883.2.1.3.2.4.17.19
	</xsl:param>
	<xsl:template match="/">
		<copiedContent>
            <xsl:copy-of select="/*/*/*/hl7:CancellationRequest/hl7:id" />
