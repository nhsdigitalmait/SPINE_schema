...
<!--PATTERN RetrievalQueryChecks-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:query[1]" priority="1000" mode="M13">

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(hl7:person.id/hl7:value[@root='2.16.840.1.113883.2.1.4.1'])=1"/><axsl:otherwise>***fault|ErrorBase1742.NHS_NUMBER_UNSPECIFIED***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="string-length(hl7:person.id/hl7:value[@root='2.16.840.1.113883.2.1.4.1']/@extension)!=0"/><axsl:otherwise>***fault|ErrorBase1742.NHS_NUMBER_UNSPECIFIED***<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M13"/></axsl:template><axsl:template match="text()" priority="-1" mode="M13"/><axsl:template match="@*|node()" priority="-2" mode="M13"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M13"/></axsl:template>
...
<!--PATTERN ReportRQDetails-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope[1]/SOAP:Body[1]/*[1]/hl7:ControlActEvent[1]/hl7:query[1]" priority="1000" mode="M15">

		<!--REPORT -->
<axsl:if test="count(hl7:person.id/hl7:value[@root='2.16.840.1.113883.2.1.4.1'])=1">***report|nhsNumber|<axsl:text/><axsl:value-of select="hl7:person.id/hl7:value[@root='2.16.840.1.113883.2.1.4.1']/@extension"/><axsl:text/>***<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M15"/></axsl:template><axsl:template match="text()" priority="-1" mode="M15"/><axsl:template match="@*|node()" priority="-2" mode="M15"><axsl:apply-templates select="*|comment()|processing-instruction()" mode="M15"/></axsl:template></axsl:stylesheet>
