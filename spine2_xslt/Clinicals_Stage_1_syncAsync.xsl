...
<!--SCHEMA METADATA-->
<axsl:template match="/"><axsl:apply-templates select="/" mode="M7"/><axsl:apply-templates select="/" mode="M8"/><axsl:apply-templates select="/" mode="M9"/><axsl:apply-templates select="/" mode="M10"/><axsl:apply-templates select="/" mode="M11"/><axsl:apply-templates select="/" mode="M12"/><axsl:apply-templates select="/" mode="M13"/></axsl:template>
...
<!--PATTERN correctRoot-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope/SOAP:Body/*/hl7:ControlActEvent/hl7:subject" priority="1000" mode="M7">
...
<!--PATTERN BodyChecks-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope/SOAP:Body/hl7:*" priority="1000" mode="M9">
...
<!--PATTERN AuthorCheck-Person-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope/SOAP:Body/hl7:*/hl7:ControlActEvent[1]/hl7:author" priority="1000" mode="M10">
...
<!--PATTERN AuthorCheck-System1-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope/SOAP:Body/hl7:*/hl7:ControlActEvent[1]/hl7:author1[1]/hl7:AgentSystemSDS/hl7:agentSystemSDS" priority="1000" mode="M11">
...
<!--PATTERN AuthorCheck-System2-->
	...
	<!--RULE -->
<axsl:template match="SOAP:Envelope/SOAP:Body/hl7:*/hl7:ControlActEvent[1]/hl7:author1[2]/hl7:AgentSystemSDS/hl7:agentSystemSDS" priority="1000" mode="M12">
