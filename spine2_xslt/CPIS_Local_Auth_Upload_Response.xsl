...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:param name="messageID">NotSupplied</xsl:param>
    <xsl:param name="responseService">cpisupload</xsl:param>
    <xsl:param name="responseAction">MCCI_IN010000UK13</xsl:param>
    <xsl:param name="responseName">successfulUploadResponse</xsl:param>
    ...
    <xsl:param name="responseText">Upload failed</xsl:param>
    ...
    <xsl:template match="/">
        <SOAP-ENV:Envelope xmlns:crs="http://national.carerecords.nhs.uk/schema/crs/" xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:wsa="http://schemas.xmlsoap.org/ws/2004/08/addressing" xmlns="urn:hl7-org:v3" xmlns:hl7="urn:hl7-org:v3">
            <SOAP-ENV:Header>
                ...
                <wsa:RelatesTo>uuid:<xsl:value-of select="$messageID"/></wsa:RelatesTo>
            </SOAP-ENV:Header>
            <SOAP-ENV:Body>
                <xsl:element name="{$responseName}">
                    <xsl:element name="{$responseAction}">
                        ...
                        <ControlActEvent classCode="CACT" moodCode="EVN">
                            ...
                            <detail><xsl:value-of select="$responseText"/></detail>
                        </ControlActEvent>
                    </xsl:element>
                </xsl:element>
            </SOAP-ENV:Body>
