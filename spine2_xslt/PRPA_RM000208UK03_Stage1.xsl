...
<!--PATTERN nhsNumberCheck-->
	...
	<!--RULE -->
<axsl:template match="/*/hl7:ControlActEvent[1]/hl7:subject[1]/hl7:PdsNhaisUpdateRequest/hl7:subject/hl7:patientRole" priority="1000" mode="M3">
